...
public class Y2016D17Tests
{
    private readonly Y2016D17 _challenge = new Y2016D17();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2016\D17\Y2016D17-input.txt", Encoding.UTF8);
