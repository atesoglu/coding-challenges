...
[ChallengeName("Scrambled Letters and Hash")]
public class Y2016D21
{
    private readonly string _input = File.ReadAllText(@"Y2016\D21\Y2016D21-input.txt", Encoding.UTF8);
