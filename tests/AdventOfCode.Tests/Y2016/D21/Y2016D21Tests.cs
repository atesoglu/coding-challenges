...
namespace AdventOfCode.Tests.Y2016.D21;

public class Y2016D21Tests
{
    private readonly Y2016D21 _challenge = new Y2016D21();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2016\D21\Y2016D21-input.txt", Encoding.UTF8);
