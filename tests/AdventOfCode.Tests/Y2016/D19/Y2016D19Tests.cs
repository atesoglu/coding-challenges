...
public class Y2016D19Tests
{
    private readonly Y2016D19 _challenge = new Y2016D19();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2016\D19\Y2016D19-input.txt", Encoding.UTF8);
