...
public class Y2016D13Tests
{
    private readonly Y2016D13 _challenge = new Y2016D13();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2016\D13\Y2016D13-input.txt", Encoding.UTF8);
