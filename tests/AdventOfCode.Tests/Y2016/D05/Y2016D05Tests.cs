...
public class Y2016D05Tests
{
    private readonly Y2016D05 _challenge = new Y2016D05();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2016\D05\Y2016D05-input.txt", Encoding.UTF8);
