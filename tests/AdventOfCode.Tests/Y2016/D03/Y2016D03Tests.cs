...
public class Y2016D03Tests
{
    private readonly Y2016D03 _challenge = new Y2016D03();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2016\D03\Y2016D03-input.txt", Encoding.UTF8);
