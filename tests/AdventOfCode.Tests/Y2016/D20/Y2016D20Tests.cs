...
public class Y2016D20Tests
{
    private readonly Y2016D20 _challenge = new Y2016D20();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2016\D20\Y2016D20-input.txt", Encoding.UTF8);
