...
public class Y2016D12Tests
{
    private readonly Y2016D12 _challenge = new Y2016D12();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2016\D12\Y2016D12-input.txt", Encoding.UTF8);
