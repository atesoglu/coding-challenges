...
public class Y2016D11Tests
{
    private readonly Y2016D11 _challenge = new Y2016D11();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2016\D11\Y2016D11-input.txt", Encoding.UTF8);
