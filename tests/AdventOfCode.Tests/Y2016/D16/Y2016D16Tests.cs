...
public class Y2016D16Tests
{
    private readonly Y2016D16 _challenge = new Y2016D16();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2016\D16\Y2016D16-input.txt", Encoding.UTF8);
