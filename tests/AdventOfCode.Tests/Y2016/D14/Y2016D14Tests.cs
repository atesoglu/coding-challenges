...
public class Y2016D14Tests
{
    private readonly Y2016D14 _challenge = new Y2016D14();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2016\D14\Y2016D14-input.txt", Encoding.UTF8);
