...
public class Y2016D07Tests
{
    private readonly Y2016D07 _challenge = new Y2016D07();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2016\D07\Y2016D07-input.txt", Encoding.UTF8);
