...
public class Y2016D25Tests
{
    private readonly Y2016D25 _challenge = new Y2016D25();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2016\D25\Y2016D25-input.txt", Encoding.UTF8);
