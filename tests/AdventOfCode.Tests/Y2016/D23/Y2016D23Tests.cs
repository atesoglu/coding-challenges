...
public class Y2016D23Tests
{
    private readonly Y2016D23 _challenge = new Y2016D23();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2016\D23\Y2016D23-input.txt", Encoding.UTF8);
