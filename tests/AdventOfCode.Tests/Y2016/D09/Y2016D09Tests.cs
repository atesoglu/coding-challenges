...
public class Y2016D09Tests
{
    private readonly Y2016D09 _challenge = new Y2016D09();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2016\D09\Y2016D09-input.txt", Encoding.UTF8);
