...
public class Y2016D15Tests
{
    private readonly Y2016D15 _challenge = new Y2016D15();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2016\D15\Y2016D15-input.txt", Encoding.UTF8);
