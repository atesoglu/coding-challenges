...
public class Y2016D08Tests
{
    private readonly Y2016D08 _challenge = new Y2016D08();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2016\D08\Y2016D08-input.txt", Encoding.UTF8);
