...
public class Y2016D04Tests
{
    private readonly Y2016D04 _challenge = new Y2016D04();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2016\D04\Y2016D04-input.txt", Encoding.UTF8);
