...
public class Y2016D18Tests
{
    private readonly Y2016D18 _challenge = new Y2016D18();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2016\D18\Y2016D18-input.txt", Encoding.UTF8);
