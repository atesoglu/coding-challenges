...
public class Y2016D22Tests
{
    private readonly Y2016D22 _challenge = new Y2016D22();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2016\D22\Y2016D22-input.txt", Encoding.UTF8);
