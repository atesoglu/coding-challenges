...
public class Y2016D01Tests
{
    private readonly Y2016D01 _challenge = new Y2016D01();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2016\D01\Y2016D01-input.txt", Encoding.UTF8);
