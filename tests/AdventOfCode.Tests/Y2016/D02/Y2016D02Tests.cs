...
public class Y2016D02Tests
{
    private readonly Y2016D02 _challenge = new Y2016D02();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2016\D02\Y2016D02-input.txt", Encoding.UTF8);
