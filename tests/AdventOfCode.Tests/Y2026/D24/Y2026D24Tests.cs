...
namespace AdventOfCode.Tests.Y2026.D24;

public class Y2026D24Tests
{
    private readonly Y2026D24 _challenge = new Y2026D24();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D24\Y2026D24-input.txt", Encoding.UTF8);
