...
namespace AdventOfCode.Tests.Y2026.D20;

public class Y2026D20Tests
{
    private readonly Y2026D20 _challenge = new Y2026D20();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D20\Y2026D20-input.txt", Encoding.UTF8);
