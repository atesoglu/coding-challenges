...
namespace AdventOfCode.Tests.Y2026.D01;

public class Y2026D01Tests
{
    private readonly Y2026D01 _challenge = new Y2026D01();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D01\Y2026D01-input.txt", Encoding.UTF8);
