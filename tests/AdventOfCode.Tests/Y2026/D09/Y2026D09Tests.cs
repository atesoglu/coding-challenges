...
namespace AdventOfCode.Tests.Y2026.D09;

public class Y2026D09Tests
{
    private readonly Y2026D09 _challenge = new Y2026D09();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D09\Y2026D09-input.txt", Encoding.UTF8);
