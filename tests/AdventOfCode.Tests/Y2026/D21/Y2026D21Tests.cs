...
namespace AdventOfCode.Tests.Y2026.D21;

public class Y2026D21Tests
{
    private readonly Y2026D21 _challenge = new Y2026D21();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D21\Y2026D21-input.txt", Encoding.UTF8);
