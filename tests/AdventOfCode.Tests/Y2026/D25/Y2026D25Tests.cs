...
namespace AdventOfCode.Tests.Y2026.D25;

public class Y2026D25Tests
{
    private readonly Y2026D25 _challenge = new Y2026D25();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D25\Y2026D25-input.txt", Encoding.UTF8);
