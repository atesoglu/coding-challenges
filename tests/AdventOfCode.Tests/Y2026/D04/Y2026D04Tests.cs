...
namespace AdventOfCode.Tests.Y2026.D04;

public class Y2026D04Tests
{
    private readonly Y2026D04 _challenge = new Y2026D04();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D04\Y2026D04-input.txt", Encoding.UTF8);
