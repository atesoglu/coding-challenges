...
namespace AdventOfCode.Tests.Y2026.D06;

public class Y2026D06Tests
{
    private readonly Y2026D06 _challenge = new Y2026D06();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D06\Y2026D06-input.txt", Encoding.UTF8);
