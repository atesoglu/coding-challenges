...
namespace AdventOfCode.Tests.Y2026.D10;

public class Y2026D10Tests
{
    private readonly Y2026D10 _challenge = new Y2026D10();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D10\Y2026D10-input.txt", Encoding.UTF8);
