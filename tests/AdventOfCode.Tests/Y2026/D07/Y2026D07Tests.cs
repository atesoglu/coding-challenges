...
namespace AdventOfCode.Tests.Y2026.D07;

public class Y2026D07Tests
{
    private readonly Y2026D07 _challenge = new Y2026D07();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D07\Y2026D07-input.txt", Encoding.UTF8);
