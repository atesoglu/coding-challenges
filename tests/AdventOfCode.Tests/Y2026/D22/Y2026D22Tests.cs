...
namespace AdventOfCode.Tests.Y2026.D22;

public class Y2026D22Tests
{
    private readonly Y2026D22 _challenge = new Y2026D22();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D22\Y2026D22-input.txt", Encoding.UTF8);
