...
namespace AdventOfCode.Tests.Y2026.D17;

public class Y2026D17Tests
{
    private readonly Y2026D17 _challenge = new Y2026D17();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D17\Y2026D17-input.txt", Encoding.UTF8);
