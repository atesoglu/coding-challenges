...
namespace AdventOfCode.Tests.Y2026.D02;

public class Y2026D02Tests
{
    private readonly Y2026D02 _challenge = new Y2026D02();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D02\Y2026D02-input.txt", Encoding.UTF8);
