...
namespace AdventOfCode.Tests.Y2026.D18;

public class Y2026D18Tests
{
    private readonly Y2026D18 _challenge = new Y2026D18();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D18\Y2026D18-input.txt", Encoding.UTF8);
