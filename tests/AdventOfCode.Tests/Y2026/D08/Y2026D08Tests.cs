...
namespace AdventOfCode.Tests.Y2026.D08;

public class Y2026D08Tests
{
    private readonly Y2026D08 _challenge = new Y2026D08();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D08\Y2026D08-input.txt", Encoding.UTF8);
