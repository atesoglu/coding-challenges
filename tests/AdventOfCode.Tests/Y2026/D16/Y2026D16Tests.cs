...
namespace AdventOfCode.Tests.Y2026.D16;

public class Y2026D16Tests
{
    private readonly Y2026D16 _challenge = new Y2026D16();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D16\Y2026D16-input.txt", Encoding.UTF8);
