...
namespace AdventOfCode.Tests.Y2026.D05;

public class Y2026D05Tests
{
    private readonly Y2026D05 _challenge = new Y2026D05();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D05\Y2026D05-input.txt", Encoding.UTF8);
