...
namespace AdventOfCode.Tests.Y2026.D23;

public class Y2026D23Tests
{
    private readonly Y2026D23 _challenge = new Y2026D23();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D23\Y2026D23-input.txt", Encoding.UTF8);
