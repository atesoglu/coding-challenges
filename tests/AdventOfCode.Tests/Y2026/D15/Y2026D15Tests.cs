...
namespace AdventOfCode.Tests.Y2026.D15;

public class Y2026D15Tests
{
    private readonly Y2026D15 _challenge = new Y2026D15();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D15\Y2026D15-input.txt", Encoding.UTF8);
