...
namespace AdventOfCode.Tests.Y2026.D14;

public class Y2026D14Tests
{
    private readonly Y2026D14 _challenge = new Y2026D14();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D14\Y2026D14-input.txt", Encoding.UTF8);
