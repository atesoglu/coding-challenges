...
namespace AdventOfCode.Tests.Y2026.D03;

public class Y2026D03Tests
{
    private readonly Y2026D03 _challenge = new Y2026D03();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D03\Y2026D03-input.txt", Encoding.UTF8);
