...
namespace AdventOfCode.Tests.Y2026.D19;

public class Y2026D19Tests
{
    private readonly Y2026D19 _challenge = new Y2026D19();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D19\Y2026D19-input.txt", Encoding.UTF8);
