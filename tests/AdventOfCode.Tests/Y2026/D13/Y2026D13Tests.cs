...
namespace AdventOfCode.Tests.Y2026.D13;

public class Y2026D13Tests
{
    private readonly Y2026D13 _challenge = new Y2026D13();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D13\Y2026D13-input.txt", Encoding.UTF8);
