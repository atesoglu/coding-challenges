...
namespace AdventOfCode.Tests.Y2026.D11;

public class Y2026D11Tests
{
    private readonly Y2026D11 _challenge = new Y2026D11();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D11\Y2026D11-input.txt", Encoding.UTF8);
