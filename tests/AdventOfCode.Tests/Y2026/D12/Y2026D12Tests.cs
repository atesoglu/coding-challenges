...
namespace AdventOfCode.Tests.Y2026.D12;

public class Y2026D12Tests
{
    private readonly Y2026D12 _challenge = new Y2026D12();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2026\D12\Y2026D12-input.txt", Encoding.UTF8);
