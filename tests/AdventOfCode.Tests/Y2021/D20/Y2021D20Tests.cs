...
public class Y2021D20Tests
{
    private readonly Y2021D20 _challenge = new Y2021D20();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D20\Y2021D20-input.txt", Encoding.UTF8);
