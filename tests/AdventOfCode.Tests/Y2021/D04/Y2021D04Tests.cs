...
public class Y2021D04Tests
{
    private readonly Y2021D04 _challenge = new Y2021D04();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D04\Y2021D04-input.txt", Encoding.UTF8);
