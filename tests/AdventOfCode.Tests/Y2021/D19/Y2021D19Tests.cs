...
public class Y2021D19Tests
{
    private readonly Y2021D19 _challenge = new Y2021D19();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D19\Y2021D19-input.txt", Encoding.UTF8);
