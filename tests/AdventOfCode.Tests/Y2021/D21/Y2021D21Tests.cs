...
public class Y2021D21Tests
{
    private readonly Y2021D21 _challenge = new Y2021D21();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D21\Y2021D21-input.txt", Encoding.UTF8);
