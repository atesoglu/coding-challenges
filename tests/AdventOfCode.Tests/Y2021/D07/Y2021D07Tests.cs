...
public class Y2021D07Tests
{
    private readonly Y2021D07 _challenge = new Y2021D07();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D07\Y2021D07-input.txt", Encoding.UTF8);
