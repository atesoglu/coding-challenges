...
public class Y2021D12Tests
{
    private readonly Y2021D12 _challenge = new Y2021D12();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D12\Y2021D12-input.txt", Encoding.UTF8);
