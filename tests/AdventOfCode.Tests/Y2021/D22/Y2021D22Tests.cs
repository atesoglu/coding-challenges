...
public class Y2021D22Tests
{
    private readonly Y2021D22 _challenge = new Y2021D22();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D22\Y2021D22-input.txt", Encoding.UTF8);
