...
public class Y2021D01Tests
{
    private readonly Y2021D01 _challenge = new Y2021D01();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D01\Y2021D01-input.txt", Encoding.UTF8);
