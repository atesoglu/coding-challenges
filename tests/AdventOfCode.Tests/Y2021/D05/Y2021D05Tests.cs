...
public class Y2021D05Tests
{
    private readonly Y2021D05 _challenge = new Y2021D05();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D05\Y2021D05-input.txt", Encoding.UTF8);
