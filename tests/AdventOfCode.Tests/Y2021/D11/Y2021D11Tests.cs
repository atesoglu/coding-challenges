...
public class Y2021D11Tests
{
    private readonly Y2021D11 _challenge = new Y2021D11();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D11\Y2021D11-input.txt", Encoding.UTF8);
