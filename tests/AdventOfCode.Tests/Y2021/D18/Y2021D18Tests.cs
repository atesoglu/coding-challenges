...
public class Y2021D18Tests
{
    private readonly Y2021D18 _challenge = new Y2021D18();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D18\Y2021D18-input.txt", Encoding.UTF8);
