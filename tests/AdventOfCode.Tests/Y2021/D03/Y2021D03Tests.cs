...
public class Y2021D03Tests
{
    private readonly Y2021D03 _challenge = new Y2021D03();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D03\Y2021D03-input.txt", Encoding.UTF8);
