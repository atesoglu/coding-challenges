...
public class Y2021D02Tests
{
    private readonly Y2021D02 _challenge = new Y2021D02();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D02\Y2021D02-input.txt", Encoding.UTF8);
