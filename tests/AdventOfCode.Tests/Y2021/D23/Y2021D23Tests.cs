...
public class Y2021D23Tests
{
    private readonly Y2021D23 _challenge = new Y2021D23();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D23\Y2021D23-input.txt", Encoding.UTF8);
