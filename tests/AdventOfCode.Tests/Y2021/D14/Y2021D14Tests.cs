...
public class Y2021D14Tests
{
    private readonly Y2021D14 _challenge = new Y2021D14();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D14\Y2021D14-input.txt", Encoding.UTF8);
