...
public class Y2021D25Tests
{
    private readonly Y2021D25 _challenge = new Y2021D25();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D25\Y2021D25-input.txt", Encoding.UTF8);
