...
public class Y2021D10Tests
{
    private readonly Y2021D10 _challenge = new Y2021D10();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D10\Y2021D10-input.txt", Encoding.UTF8);
