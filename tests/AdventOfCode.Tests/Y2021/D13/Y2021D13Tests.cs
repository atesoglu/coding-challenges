...
public class Y2021D13Tests
{
    private readonly Y2021D13 _challenge = new Y2021D13();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D13\Y2021D13-input.txt", Encoding.UTF8);
