...
public class Y2021D08Tests
{
    private readonly Y2021D08 _challenge = new Y2021D08();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D08\Y2021D08-input.txt", Encoding.UTF8);
