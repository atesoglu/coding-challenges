...
public class Y2021D06Tests
{
    private readonly Y2021D06 _challenge = new Y2021D06();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D06\Y2021D06-input.txt", Encoding.UTF8);
