...
public class Y2021D17Tests
{
    private readonly Y2021D17 _challenge = new Y2021D17();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D17\Y2021D17-input.txt", Encoding.UTF8);
