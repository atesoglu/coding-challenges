...
public class Y2021D16Tests
{
    private readonly Y2021D16 _challenge = new Y2021D16();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D16\Y2021D16-input.txt", Encoding.UTF8);
