...
public class Y2021D09Tests
{
    private readonly Y2021D09 _challenge = new Y2021D09();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D09\Y2021D09-input.txt", Encoding.UTF8);
