...
namespace AdventOfCode.Tests.Y2021.D24;

public class Y2021D24Tests
{
    private readonly Y2021D24 _challenge = new Y2021D24();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D24\Y2021D24-input.txt", Encoding.UTF8);
