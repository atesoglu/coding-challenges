...
namespace AdventOfCode.Tests.Y2021.D15;

public class Y2021D15Tests
{
    private readonly Y2021D15 _challenge = new Y2021D15();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2021\D15\Y2021D15-input.txt", Encoding.UTF8);
