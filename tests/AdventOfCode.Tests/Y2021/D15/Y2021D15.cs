...
[ChallengeName("Chiton")]
public class Y2021D15
{
    private readonly string _input = File.ReadAllText(@"Y2021\D15\Y2021D15-input.txt", Encoding.UTF8);
    ...
    int Solve(Dictionary<Point, int> riskMap)
    {
        ...
        // â­ .Net 6 finally has a PriorityQueue collection :)
