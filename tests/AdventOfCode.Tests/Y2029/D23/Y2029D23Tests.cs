...
namespace AdventOfCode.Tests.Y2029.D23;

public class Y2029D23Tests
{
    private readonly Y2029D23 _challenge = new Y2029D23();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D23\Y2029D23-input.txt", Encoding.UTF8);
