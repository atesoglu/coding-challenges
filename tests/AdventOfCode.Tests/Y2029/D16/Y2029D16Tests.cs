...
namespace AdventOfCode.Tests.Y2029.D16;

public class Y2029D16Tests
{
    private readonly Y2029D16 _challenge = new Y2029D16();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D16\Y2029D16-input.txt", Encoding.UTF8);
