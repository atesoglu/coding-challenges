...
namespace AdventOfCode.Tests.Y2029.D20;

public class Y2029D20Tests
{
    private readonly Y2029D20 _challenge = new Y2029D20();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D20\Y2029D20-input.txt", Encoding.UTF8);
