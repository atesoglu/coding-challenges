...
namespace AdventOfCode.Tests.Y2029.D21;

public class Y2029D21Tests
{
    private readonly Y2029D21 _challenge = new Y2029D21();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D21\Y2029D21-input.txt", Encoding.UTF8);
