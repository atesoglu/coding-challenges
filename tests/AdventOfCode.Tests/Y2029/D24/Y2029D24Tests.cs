...
namespace AdventOfCode.Tests.Y2029.D24;

public class Y2029D24Tests
{
    private readonly Y2029D24 _challenge = new Y2029D24();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D24\Y2029D24-input.txt", Encoding.UTF8);
