...
namespace AdventOfCode.Tests.Y2029.D11;

public class Y2029D11Tests
{
    private readonly Y2029D11 _challenge = new Y2029D11();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D11\Y2029D11-input.txt", Encoding.UTF8);
