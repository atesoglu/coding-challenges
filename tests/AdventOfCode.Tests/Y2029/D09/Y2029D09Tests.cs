...
namespace AdventOfCode.Tests.Y2029.D09;

public class Y2029D09Tests
{
    private readonly Y2029D09 _challenge = new Y2029D09();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D09\Y2029D09-input.txt", Encoding.UTF8);
