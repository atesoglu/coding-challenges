...
namespace AdventOfCode.Tests.Y2029.D15;

public class Y2029D15Tests
{
    private readonly Y2029D15 _challenge = new Y2029D15();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D15\Y2029D15-input.txt", Encoding.UTF8);
