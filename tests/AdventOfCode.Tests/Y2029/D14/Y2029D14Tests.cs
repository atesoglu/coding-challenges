...
namespace AdventOfCode.Tests.Y2029.D14;

public class Y2029D14Tests
{
    private readonly Y2029D14 _challenge = new Y2029D14();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D14\Y2029D14-input.txt", Encoding.UTF8);
