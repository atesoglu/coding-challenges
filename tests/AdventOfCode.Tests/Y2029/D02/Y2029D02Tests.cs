...
namespace AdventOfCode.Tests.Y2029.D02;

public class Y2029D02Tests
{
    private readonly Y2029D02 _challenge = new Y2029D02();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D02\Y2029D02-input.txt", Encoding.UTF8);
