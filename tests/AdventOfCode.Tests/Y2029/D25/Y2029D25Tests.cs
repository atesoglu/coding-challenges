...
namespace AdventOfCode.Tests.Y2029.D25;

public class Y2029D25Tests
{
    private readonly Y2029D25 _challenge = new Y2029D25();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D25\Y2029D25-input.txt", Encoding.UTF8);
