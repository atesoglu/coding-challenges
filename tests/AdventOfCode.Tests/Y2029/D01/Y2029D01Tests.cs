...
public class Y2029D01Tests
{
    private readonly Y2029D01 _challenge = new Y2029D01();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D01\Y2029D01-input.txt", Encoding.UTF8);
