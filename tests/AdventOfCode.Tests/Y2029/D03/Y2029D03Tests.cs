...
namespace AdventOfCode.Tests.Y2029.D03;

public class Y2029D03Tests
{
    private readonly Y2029D03 _challenge = new Y2029D03();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D03\Y2029D03-input.txt", Encoding.UTF8);
