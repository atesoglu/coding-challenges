...
namespace AdventOfCode.Tests.Y2029.D17;

public class Y2029D17Tests
{
    private readonly Y2029D17 _challenge = new Y2029D17();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D17\Y2029D17-input.txt", Encoding.UTF8);
