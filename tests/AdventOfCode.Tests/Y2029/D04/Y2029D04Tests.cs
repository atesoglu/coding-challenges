...
namespace AdventOfCode.Tests.Y2029.D04;

public class Y2029D04Tests
{
    private readonly Y2029D04 _challenge = new Y2029D04();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D04\Y2029D04-input.txt", Encoding.UTF8);
