...
namespace AdventOfCode.Tests.Y2029.D06;

public class Y2029D06Tests
{
    private readonly Y2029D06 _challenge = new Y2029D06();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D06\Y2029D06-input.txt", Encoding.UTF8);
