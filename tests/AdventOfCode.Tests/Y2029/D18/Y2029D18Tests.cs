...
namespace AdventOfCode.Tests.Y2029.D18;

public class Y2029D18Tests
{
    private readonly Y2029D18 _challenge = new Y2029D18();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D18\Y2029D18-input.txt", Encoding.UTF8);
