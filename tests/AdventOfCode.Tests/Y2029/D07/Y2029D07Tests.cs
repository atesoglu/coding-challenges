...
namespace AdventOfCode.Tests.Y2029.D07;

public class Y2029D07Tests
{
    private readonly Y2029D07 _challenge = new Y2029D07();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D07\Y2029D07-input.txt", Encoding.UTF8);
