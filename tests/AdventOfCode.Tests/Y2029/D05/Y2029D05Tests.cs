...
namespace AdventOfCode.Tests.Y2029.D05;

public class Y2029D05Tests
{
    private readonly Y2029D05 _challenge = new Y2029D05();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D05\Y2029D05-input.txt", Encoding.UTF8);
