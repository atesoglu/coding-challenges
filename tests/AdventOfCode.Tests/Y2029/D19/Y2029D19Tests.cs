...
namespace AdventOfCode.Tests.Y2029.D19;

public class Y2029D19Tests
{
    private readonly Y2029D19 _challenge = new Y2029D19();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D19\Y2029D19-input.txt", Encoding.UTF8);
