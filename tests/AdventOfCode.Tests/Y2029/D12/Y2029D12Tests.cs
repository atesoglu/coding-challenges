...
namespace AdventOfCode.Tests.Y2029.D12;

public class Y2029D12Tests
{
    private readonly Y2029D12 _challenge = new Y2029D12();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D12\Y2029D12-input.txt", Encoding.UTF8);
