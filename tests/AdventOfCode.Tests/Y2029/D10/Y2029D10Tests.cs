...
namespace AdventOfCode.Tests.Y2029.D10;

public class Y2029D10Tests
{
    private readonly Y2029D10 _challenge = new Y2029D10();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D10\Y2029D10-input.txt", Encoding.UTF8);
