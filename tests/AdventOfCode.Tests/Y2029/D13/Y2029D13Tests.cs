...
namespace AdventOfCode.Tests.Y2029.D13;

public class Y2029D13Tests
{
    private readonly Y2029D13 _challenge = new Y2029D13();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D13\Y2029D13-input.txt", Encoding.UTF8);
