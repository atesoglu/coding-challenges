...
namespace AdventOfCode.Tests.Y2029.D08;

public class Y2029D08Tests
{
    private readonly Y2029D08 _challenge = new Y2029D08();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D08\Y2029D08-input.txt", Encoding.UTF8);
