...
namespace AdventOfCode.Tests.Y2029.D22;

public class Y2029D22Tests
{
    private readonly Y2029D22 _challenge = new Y2029D22();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2029\D22\Y2029D22-input.txt", Encoding.UTF8);
