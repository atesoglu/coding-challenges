...
public class Y2019D04Tests
{
    private readonly Y2019D04 _challenge = new Y2019D04();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D04\Y2019D04-input.txt", Encoding.UTF8);
