...
public class Y2019D02Tests
{
    private readonly Y2019D02 _challenge = new Y2019D02();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D02\Y2019D02-input.txt", Encoding.UTF8);
