...
public class Y2019D01Tests
{
    private readonly Y2019D01 _challenge = new Y2019D01();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D01\Y2019D01-input.txt", Encoding.UTF8);
