...
public class Y2019D15Tests
{
    private readonly Y2019D15 _challenge = new Y2019D15();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D15\Y2019D15-input.txt", Encoding.UTF8);
