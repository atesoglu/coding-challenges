...
public class Y2019D05Tests
{
    private readonly Y2019D05 _challenge = new Y2019D05();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D05\Y2019D05-input.txt", Encoding.UTF8);
