...
public class Y2019D11Tests
{
    private readonly Y2019D11 _challenge = new Y2019D11();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D11\Y2019D11-input.txt", Encoding.UTF8);
