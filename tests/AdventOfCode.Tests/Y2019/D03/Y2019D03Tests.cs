...
public class Y2019D03Tests
{
    private readonly Y2019D03 _challenge = new Y2019D03();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D03\Y2019D03-input.txt", Encoding.UTF8);
