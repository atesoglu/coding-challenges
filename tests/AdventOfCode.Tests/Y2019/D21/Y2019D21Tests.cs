...
public class Y2019D21Tests
{
    private readonly Y2019D21 _challenge = new Y2019D21();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D21\Y2019D21-input.txt", Encoding.UTF8);
