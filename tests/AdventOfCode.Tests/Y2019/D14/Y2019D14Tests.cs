...
public class Y2019D14Tests
{
    private readonly Y2019D14 _challenge = new Y2019D14();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D14\Y2019D14-input.txt", Encoding.UTF8);
