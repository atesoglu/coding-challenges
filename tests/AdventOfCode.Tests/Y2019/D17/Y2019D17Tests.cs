...
public class Y2019D17Tests
{
    private readonly Y2019D17 _challenge = new Y2019D17();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D17\Y2019D17-input.txt", Encoding.UTF8);
