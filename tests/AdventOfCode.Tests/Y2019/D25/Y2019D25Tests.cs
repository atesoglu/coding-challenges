...
public class Y2019D25Tests
{
    private readonly Y2019D25 _challenge = new Y2019D25();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D25\Y2019D25-input.txt", Encoding.UTF8);
