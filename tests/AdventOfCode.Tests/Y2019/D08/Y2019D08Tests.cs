...
public class Y2019D08Tests
{
    private readonly Y2019D08 _challenge = new Y2019D08();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D08\Y2019D08-input.txt", Encoding.UTF8);
