...
public class Y2019D24Tests
{
    private readonly Y2019D24 _challenge = new Y2019D24();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D24\Y2019D24-input.txt", Encoding.UTF8);
