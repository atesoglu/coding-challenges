...
public class Y2019D18Tests
{
    private readonly Y2019D18 _challenge = new Y2019D18();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D18\Y2019D18-input.txt", Encoding.UTF8);
