...
public class Y2019D07Tests
{
    private readonly Y2019D07 _challenge = new Y2019D07();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D07\Y2019D07-input.txt", Encoding.UTF8);
