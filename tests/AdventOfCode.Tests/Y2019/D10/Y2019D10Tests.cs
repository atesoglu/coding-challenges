...
public class Y2019D10Tests
{
    private readonly Y2019D10 _challenge = new Y2019D10();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D10\Y2019D10-input.txt", Encoding.UTF8);
