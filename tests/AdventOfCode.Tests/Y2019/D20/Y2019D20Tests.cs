...
public class Y2019D20Tests
{
    private readonly Y2019D20 _challenge = new Y2019D20();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D20\Y2019D20-input.txt", Encoding.UTF8);
