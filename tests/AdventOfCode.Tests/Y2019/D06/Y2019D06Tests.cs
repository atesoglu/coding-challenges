...
public class Y2019D06Tests
{
    private readonly Y2019D06 _challenge = new Y2019D06();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D06\Y2019D06-input.txt", Encoding.UTF8);
