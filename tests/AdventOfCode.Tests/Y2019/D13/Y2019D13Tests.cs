...
public class Y2019D13Tests
{
    private readonly Y2019D13 _challenge = new Y2019D13();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D13\Y2019D13-input.txt", Encoding.UTF8);
