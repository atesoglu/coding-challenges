...
public class Y2019D12Tests
{
    private readonly Y2019D12 _challenge = new Y2019D12();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D12\Y2019D12-input.txt", Encoding.UTF8);
