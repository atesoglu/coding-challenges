...
public class Y2019D19Tests
{
    private readonly Y2019D19 _challenge = new Y2019D19();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D19\Y2019D19-input.txt", Encoding.UTF8);
