...
public class Y2019D23Tests
{
    private readonly Y2019D23 _challenge = new Y2019D23();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D23\Y2019D23-input.txt", Encoding.UTF8);
