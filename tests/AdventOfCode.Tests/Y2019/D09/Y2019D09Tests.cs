...
public class Y2019D09Tests
{
    private readonly Y2019D09 _challenge = new Y2019D09();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D09\Y2019D09-input.txt", Encoding.UTF8);
