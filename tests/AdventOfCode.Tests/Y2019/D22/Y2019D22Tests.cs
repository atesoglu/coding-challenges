...
public class Y2019D22Tests
{
    private readonly Y2019D22 _challenge = new Y2019D22();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D22\Y2019D22-input.txt", Encoding.UTF8);
