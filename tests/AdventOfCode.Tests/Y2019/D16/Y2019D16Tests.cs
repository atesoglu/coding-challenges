...
public class Y2019D16Tests
{
    private readonly Y2019D16 _challenge = new Y2019D16();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2019\D16\Y2019D16-input.txt", Encoding.UTF8);
