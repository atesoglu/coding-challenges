...
namespace AdventOfCode.Tests.Y2027.D21;

public class Y2027D21Tests
{
    private readonly Y2027D21 _challenge = new Y2027D21();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D21\Y2027D21-input.txt", Encoding.UTF8);
