...
namespace AdventOfCode.Tests.Y2027.D16;

public class Y2027D16Tests
{
    private readonly Y2027D16 _challenge = new Y2027D16();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D16\Y2027D16-input.txt", Encoding.UTF8);
