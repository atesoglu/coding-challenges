...
namespace AdventOfCode.Tests.Y2027.D14;

public class Y2027D14Tests
{
    private readonly Y2027D14 _challenge = new Y2027D14();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D14\Y2027D14-input.txt", Encoding.UTF8);
