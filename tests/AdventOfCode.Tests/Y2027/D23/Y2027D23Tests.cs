...
namespace AdventOfCode.Tests.Y2027.D23;

public class Y2027D23Tests
{
    private readonly Y2027D23 _challenge = new Y2027D23();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D23\Y2027D23-input.txt", Encoding.UTF8);
