...
namespace AdventOfCode.Tests.Y2027.D07;

public class Y2027D07Tests
{
    private readonly Y2027D07 _challenge = new Y2027D07();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D07\Y2027D07-input.txt", Encoding.UTF8);
