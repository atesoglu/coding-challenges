...
namespace AdventOfCode.Tests.Y2027.D20;

public class Y2027D20Tests
{
    private readonly Y2027D20 _challenge = new Y2027D20();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D20\Y2027D20-input.txt", Encoding.UTF8);
