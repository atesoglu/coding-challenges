...
namespace AdventOfCode.Tests.Y2027.D04;

public class Y2027D04Tests
{
    private readonly Y2027D04 _challenge = new Y2027D04();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D04\Y2027D04-input.txt", Encoding.UTF8);
