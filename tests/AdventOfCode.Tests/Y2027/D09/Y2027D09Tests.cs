...
namespace AdventOfCode.Tests.Y2027.D09;

public class Y2027D09Tests
{
    private readonly Y2027D09 _challenge = new Y2027D09();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D09\Y2027D09-input.txt", Encoding.UTF8);
