...
namespace AdventOfCode.Tests.Y2027.D03;

public class Y2027D03Tests
{
    private readonly Y2027D03 _challenge = new Y2027D03();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D03\Y2027D03-input.txt", Encoding.UTF8);
