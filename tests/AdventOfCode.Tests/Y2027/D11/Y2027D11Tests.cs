...
namespace AdventOfCode.Tests.Y2027.D11;

public class Y2027D11Tests
{
    private readonly Y2027D11 _challenge = new Y2027D11();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D11\Y2027D11-input.txt", Encoding.UTF8);
