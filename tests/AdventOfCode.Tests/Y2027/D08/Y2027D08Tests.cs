...
namespace AdventOfCode.Tests.Y2027.D08;

public class Y2027D08Tests
{
    private readonly Y2027D08 _challenge = new Y2027D08();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D08\Y2027D08-input.txt", Encoding.UTF8);
