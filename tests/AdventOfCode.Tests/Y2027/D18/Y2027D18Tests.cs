...
namespace AdventOfCode.Tests.Y2027.D18;

public class Y2027D18Tests
{
    private readonly Y2027D18 _challenge = new Y2027D18();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D18\Y2027D18-input.txt", Encoding.UTF8);
