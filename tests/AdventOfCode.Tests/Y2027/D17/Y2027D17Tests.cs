...
namespace AdventOfCode.Tests.Y2027.D17;

public class Y2027D17Tests
{
    private readonly Y2027D17 _challenge = new Y2027D17();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D17\Y2027D17-input.txt", Encoding.UTF8);
