...
namespace AdventOfCode.Tests.Y2027.D24;

public class Y2027D24Tests
{
    private readonly Y2027D24 _challenge = new Y2027D24();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D24\Y2027D24-input.txt", Encoding.UTF8);
