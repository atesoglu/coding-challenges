...
namespace AdventOfCode.Tests.Y2027.D05;

public class Y2027D05Tests
{
    private readonly Y2027D05 _challenge = new Y2027D05();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D05\Y2027D05-input.txt", Encoding.UTF8);
