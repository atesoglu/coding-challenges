...
public class Y2027D01Tests
{
    private readonly Y2027D01 _challenge = new Y2027D01();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D01\Y2027D01-input.txt", Encoding.UTF8);
