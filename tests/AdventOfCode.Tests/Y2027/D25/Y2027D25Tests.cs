...
namespace AdventOfCode.Tests.Y2027.D25;

public class Y2027D25Tests
{
    private readonly Y2027D25 _challenge = new Y2027D25();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D25\Y2027D25-input.txt", Encoding.UTF8);
