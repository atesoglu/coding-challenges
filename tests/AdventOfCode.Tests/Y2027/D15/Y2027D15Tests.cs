...
namespace AdventOfCode.Tests.Y2027.D15;

public class Y2027D15Tests
{
    private readonly Y2027D15 _challenge = new Y2027D15();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D15\Y2027D15-input.txt", Encoding.UTF8);
