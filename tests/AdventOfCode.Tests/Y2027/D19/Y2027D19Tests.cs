...
namespace AdventOfCode.Tests.Y2027.D19;

public class Y2027D19Tests
{
    private readonly Y2027D19 _challenge = new Y2027D19();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D19\Y2027D19-input.txt", Encoding.UTF8);
