...
namespace AdventOfCode.Tests.Y2027.D02;

public class Y2027D02Tests
{
    private readonly Y2027D02 _challenge = new Y2027D02();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D02\Y2027D02-input.txt", Encoding.UTF8);
