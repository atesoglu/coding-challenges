...
namespace AdventOfCode.Tests.Y2027.D22;

public class Y2027D22Tests
{
    private readonly Y2027D22 _challenge = new Y2027D22();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D22\Y2027D22-input.txt", Encoding.UTF8);
