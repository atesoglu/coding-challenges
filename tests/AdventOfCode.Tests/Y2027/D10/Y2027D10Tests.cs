...
namespace AdventOfCode.Tests.Y2027.D10;

public class Y2027D10Tests
{
    private readonly Y2027D10 _challenge = new Y2027D10();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D10\Y2027D10-input.txt", Encoding.UTF8);
