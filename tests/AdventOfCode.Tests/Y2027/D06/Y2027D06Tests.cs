...
namespace AdventOfCode.Tests.Y2027.D06;

public class Y2027D06Tests
{
    private readonly Y2027D06 _challenge = new Y2027D06();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D06\Y2027D06-input.txt", Encoding.UTF8);
