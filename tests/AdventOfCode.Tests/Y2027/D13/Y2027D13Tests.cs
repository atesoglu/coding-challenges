...
namespace AdventOfCode.Tests.Y2027.D13;

public class Y2027D13Tests
{
    private readonly Y2027D13 _challenge = new Y2027D13();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2027\D13\Y2027D13-input.txt", Encoding.UTF8);
