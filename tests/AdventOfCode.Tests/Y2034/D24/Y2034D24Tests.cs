...
namespace AdventOfCode.Tests.Y2034.D24;

public class Y2034D24Tests
{
    private readonly Y2034D24 _challenge = new Y2034D24();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D24\Y2034D24-input.txt", Encoding.UTF8);
