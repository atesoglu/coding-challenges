...
namespace AdventOfCode.Tests.Y2034.D11;

public class Y2034D11Tests
{
    private readonly Y2034D11 _challenge = new Y2034D11();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D11\Y2034D11-input.txt", Encoding.UTF8);
