...
public class Y2034D25Tests
{
    private readonly Y2034D25 _challenge = new Y2034D25();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D25\Y2034D25-input.txt", Encoding.UTF8);
