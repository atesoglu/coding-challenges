...
namespace AdventOfCode.Tests.Y2034.D02;

public class Y2034D02Tests
{
    private readonly Y2034D02 _challenge = new Y2034D02();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D02\Y2034D02-input.txt", Encoding.UTF8);
