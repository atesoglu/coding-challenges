...
namespace AdventOfCode.Tests.Y2034.D04;

public class Y2034D04Tests
{
    private readonly Y2034D04 _challenge = new Y2034D04();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D04\Y2034D04-input.txt", Encoding.UTF8);
