...
namespace AdventOfCode.Tests.Y2034.D20;

public class Y2034D20Tests
{
    private readonly Y2034D20 _challenge = new Y2034D20();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D20\Y2034D20-input.txt", Encoding.UTF8);
