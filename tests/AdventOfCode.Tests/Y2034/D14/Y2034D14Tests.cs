...
namespace AdventOfCode.Tests.Y2034.D14;

public class Y2034D14Tests
{
    private readonly Y2034D14 _challenge = new Y2034D14();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D14\Y2034D14-input.txt", Encoding.UTF8);
