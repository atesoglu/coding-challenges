...
namespace AdventOfCode.Tests.Y2034.D19;

public class Y2034D19Tests
{
    private readonly Y2034D19 _challenge = new Y2034D19();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D19\Y2034D19-input.txt", Encoding.UTF8);
