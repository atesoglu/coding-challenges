...
namespace AdventOfCode.Tests.Y2034.D08;

public class Y2034D08Tests
{
    private readonly Y2034D08 _challenge = new Y2034D08();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D08\Y2034D08-input.txt", Encoding.UTF8);
