...
namespace AdventOfCode.Tests.Y2034.D05;

public class Y2034D05Tests
{
    private readonly Y2034D05 _challenge = new Y2034D05();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D05\Y2034D05-input.txt", Encoding.UTF8);
