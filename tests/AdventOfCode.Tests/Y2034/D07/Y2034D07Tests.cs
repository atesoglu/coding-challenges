...
namespace AdventOfCode.Tests.Y2034.D07;

public class Y2034D07Tests
{
    private readonly Y2034D07 _challenge = new Y2034D07();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D07\Y2034D07-input.txt", Encoding.UTF8);
