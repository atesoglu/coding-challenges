...
namespace AdventOfCode.Tests.Y2034.D21;

public class Y2034D21Tests
{
    private readonly Y2034D21 _challenge = new Y2034D21();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D21\Y2034D21-input.txt", Encoding.UTF8);
