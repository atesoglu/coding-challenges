...
namespace AdventOfCode.Tests.Y2034.D10;

public class Y2034D10Tests
{
    private readonly Y2034D10 _challenge = new Y2034D10();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D10\Y2034D10-input.txt", Encoding.UTF8);
