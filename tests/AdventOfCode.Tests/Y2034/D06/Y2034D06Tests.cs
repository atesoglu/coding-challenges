...
namespace AdventOfCode.Tests.Y2034.D06;

public class Y2034D06Tests
{
    private readonly Y2034D06 _challenge = new Y2034D06();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D06\Y2034D06-input.txt", Encoding.UTF8);
