...
namespace AdventOfCode.Tests.Y2034.D16;

public class Y2034D16Tests
{
    private readonly Y2034D16 _challenge = new Y2034D16();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D16\Y2034D16-input.txt", Encoding.UTF8);
