...
namespace AdventOfCode.Tests.Y2034.D12;

public class Y2034D12Tests
{
    private readonly Y2034D12 _challenge = new Y2034D12();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D12\Y2034D12-input.txt", Encoding.UTF8);
