...
namespace AdventOfCode.Tests.Y2034.D03;

public class Y2034D03Tests
{
    private readonly Y2034D03 _challenge = new Y2034D03();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D03\Y2034D03-input.txt", Encoding.UTF8);
