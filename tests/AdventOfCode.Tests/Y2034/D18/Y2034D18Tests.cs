...
namespace AdventOfCode.Tests.Y2034.D18;

public class Y2034D18Tests
{
    private readonly Y2034D18 _challenge = new Y2034D18();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D18\Y2034D18-input.txt", Encoding.UTF8);
