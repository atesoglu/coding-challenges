...
namespace AdventOfCode.Tests.Y2034.D15;

public class Y2034D15Tests
{
    private readonly Y2034D15 _challenge = new Y2034D15();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D15\Y2034D15-input.txt", Encoding.UTF8);
