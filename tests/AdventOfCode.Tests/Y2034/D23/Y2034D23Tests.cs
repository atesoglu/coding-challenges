...
namespace AdventOfCode.Tests.Y2034.D23;

public class Y2034D23Tests
{
    private readonly Y2034D23 _challenge = new Y2034D23();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D23\Y2034D23-input.txt", Encoding.UTF8);
