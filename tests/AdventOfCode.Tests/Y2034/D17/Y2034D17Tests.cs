...
namespace AdventOfCode.Tests.Y2034.D17;

public class Y2034D17Tests
{
    private readonly Y2034D17 _challenge = new Y2034D17();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D17\Y2034D17-input.txt", Encoding.UTF8);
