...
namespace AdventOfCode.Tests.Y2034.D09;

public class Y2034D09Tests
{
    private readonly Y2034D09 _challenge = new Y2034D09();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D09\Y2034D09-input.txt", Encoding.UTF8);
