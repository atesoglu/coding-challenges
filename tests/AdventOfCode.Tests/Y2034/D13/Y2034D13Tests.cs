...
namespace AdventOfCode.Tests.Y2034.D13;

public class Y2034D13Tests
{
    private readonly Y2034D13 _challenge = new Y2034D13();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D13\Y2034D13-input.txt", Encoding.UTF8);
