...
namespace AdventOfCode.Tests.Y2034.D01;

public class Y2034D01Tests
{
    private readonly Y2034D01 _challenge = new Y2034D01();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D01\Y2034D01-input.txt", Encoding.UTF8);
