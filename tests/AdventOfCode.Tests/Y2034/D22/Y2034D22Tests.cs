...
namespace AdventOfCode.Tests.Y2034.D22;

public class Y2034D22Tests
{
    private readonly Y2034D22 _challenge = new Y2034D22();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2034\D22\Y2034D22-input.txt", Encoding.UTF8);
