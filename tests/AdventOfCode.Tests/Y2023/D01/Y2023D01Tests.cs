...
public class Y2023D01Tests
{
    private readonly Y2023D01 _challenge = new Y2023D01();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D01\Y2023D01-input.txt", Encoding.UTF8);
