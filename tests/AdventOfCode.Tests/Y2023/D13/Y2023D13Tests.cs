...
public class Y2023D13Tests
{
    private readonly Y2023D13 _challenge = new Y2023D13();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D13\Y2023D13-input.txt", Encoding.UTF8);
