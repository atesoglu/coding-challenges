...
public class Y2023D04Tests
{
    private readonly Y2023D04 _challenge = new Y2023D04();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D04\Y2023D04-input.txt", Encoding.UTF8);
