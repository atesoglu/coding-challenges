...
public class Y2023D16Tests
{
    private readonly Y2023D16 _challenge = new Y2023D16();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D16\Y2023D16-input.txt", Encoding.UTF8);
