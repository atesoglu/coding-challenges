...
namespace AdventOfCode.Tests.Y2023.D25;

public class Y2023D25Tests
{
    private readonly Y2023D25 _challenge = new Y2023D25();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D25\Y2023D25-input.txt", Encoding.UTF8);
