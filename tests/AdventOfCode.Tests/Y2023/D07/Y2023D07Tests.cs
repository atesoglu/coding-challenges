...
public class Y2023D07Tests
{
    private readonly Y2023D07 _challenge = new Y2023D07();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D07\Y2023D07-input.txt", Encoding.UTF8);
