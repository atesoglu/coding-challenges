...
public class Y2023D11Tests
{
    private readonly Y2023D11 _challenge = new Y2023D11();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D11\Y2023D11-input.txt", Encoding.UTF8);
