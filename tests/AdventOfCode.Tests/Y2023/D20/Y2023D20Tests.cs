...
public class Y2023D20Tests
{
    private readonly Y2023D20 _challenge = new Y2023D20();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D20\Y2023D20-input.txt", Encoding.UTF8);
