...
namespace AdventOfCode.Tests.Y2023.D10;

public class Y2023D10Tests
{
    private readonly Y2023D10 _challenge = new Y2023D10();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D10\Y2023D10-input.txt", Encoding.UTF8);
