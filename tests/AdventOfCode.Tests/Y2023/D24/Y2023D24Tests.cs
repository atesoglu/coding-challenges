...
public class Y2023D24Tests
{
    private readonly Y2023D24 _challenge = new Y2023D24();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D24\Y2023D24-input.txt", Encoding.UTF8);
