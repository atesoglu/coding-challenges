...
public class Y2023D22Tests
{
    private readonly Y2023D22 _challenge = new Y2023D22();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D22\Y2023D22-input.txt", Encoding.UTF8);
