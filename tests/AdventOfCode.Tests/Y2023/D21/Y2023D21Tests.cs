...
public class Y2023D21Tests
{
    private readonly Y2023D21 _challenge = new Y2023D21();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D21\Y2023D21-input.txt", Encoding.UTF8);
