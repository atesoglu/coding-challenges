...
[ChallengeName("Wait For It")]
public class Y2023D06
{
    private readonly string _input = File.ReadAllText(@"Y2023\D06\Y2023D06-input.txt", Encoding.UTF8);
    ...
    public void PartOne()
    {
        ...
        output.Should().Be(32076);
    }

    [Fact]
    public void PartTwo()
    {
        var output = Solve(_input.Replace(" ", ""));

        output.Should().Be(34278221);
    }
