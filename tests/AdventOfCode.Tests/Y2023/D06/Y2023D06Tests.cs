...
public class Y2023D06Tests
{
    private readonly Y2023D06 _challenge = new Y2023D06();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D06\Y2023D06-input.txt", Encoding.UTF8);
