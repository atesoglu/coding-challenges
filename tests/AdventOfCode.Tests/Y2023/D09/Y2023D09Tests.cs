...
public class Y2023D09Tests
{
    private readonly Y2023D09 _challenge = new Y2023D09();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D09\Y2023D09-input.txt", Encoding.UTF8);
