...
public class Y2023D02Tests
{
    private readonly Y2023D02 _challenge = new Y2023D02();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D02\Y2023D02-input.txt", Encoding.UTF8);
