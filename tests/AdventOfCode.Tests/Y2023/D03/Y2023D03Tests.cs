...
public class Y2023D03Tests
{
    private readonly Y2023D03 _challenge = new Y2023D03();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D03\Y2023D03-input.txt", Encoding.UTF8);
