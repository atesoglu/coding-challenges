...
namespace AdventOfCode.Tests.Y2023.D14;

public class Y2023D14Tests
{
    private readonly Y2023D14 _challenge = new Y2023D14();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D14\Y2023D14-input.txt", Encoding.UTF8);
