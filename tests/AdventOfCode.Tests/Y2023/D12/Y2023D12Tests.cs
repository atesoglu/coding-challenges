...
public class Y2023D12Tests
{
    private readonly Y2023D12 _challenge = new Y2023D12();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D12\Y2023D12-input.txt", Encoding.UTF8);
