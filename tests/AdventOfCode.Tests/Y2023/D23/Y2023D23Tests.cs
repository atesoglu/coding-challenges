...
namespace AdventOfCode.Tests.Y2023.D23;

public class Y2023D23Tests
{
    private readonly Y2023D23 _challenge = new Y2023D23();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D23\Y2023D23-input.txt", Encoding.UTF8);
