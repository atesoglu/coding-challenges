...
public class Y2023D17Tests
{
    private readonly Y2023D17 _challenge = new Y2023D17();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D17\Y2023D17-input.txt", Encoding.UTF8);
