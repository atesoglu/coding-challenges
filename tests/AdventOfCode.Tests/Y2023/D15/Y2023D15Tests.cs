...
public class Y2023D15Tests
{
    private readonly Y2023D15 _challenge = new Y2023D15();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D15\Y2023D15-input.txt", Encoding.UTF8);
