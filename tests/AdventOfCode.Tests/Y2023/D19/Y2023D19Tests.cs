...
public class Y2023D19Tests
{
    private readonly Y2023D19 _challenge = new Y2023D19();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D19\Y2023D19-input.txt", Encoding.UTF8);
