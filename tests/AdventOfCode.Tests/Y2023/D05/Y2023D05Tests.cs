...
public class Y2023D05Tests
{
    private readonly Y2023D05 _challenge = new Y2023D05();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D05\Y2023D05-input.txt", Encoding.UTF8);
