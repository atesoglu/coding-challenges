...
public class Y2023D18Tests
{
    private readonly Y2023D18 _challenge = new Y2023D18();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2023\D18\Y2023D18-input.txt", Encoding.UTF8);
