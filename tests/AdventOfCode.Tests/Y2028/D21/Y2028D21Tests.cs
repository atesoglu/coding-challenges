...
namespace AdventOfCode.Tests.Y2028.D21;

public class Y2028D21Tests
{
    private readonly Y2028D21 _challenge = new Y2028D21();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D21\Y2028D21-input.txt", Encoding.UTF8);
