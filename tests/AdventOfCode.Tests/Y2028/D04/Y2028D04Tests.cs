...
public class Y2028D04Tests
{
    private readonly Y2028D04 _challenge = new Y2028D04();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D04\Y2028D04-input.txt", Encoding.UTF8);
