...
public class Y2028D05Tests
{
    private readonly Y2028D05 _challenge = new Y2028D05();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D05\Y2028D05-input.txt", Encoding.UTF8);
