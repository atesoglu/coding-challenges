...
public class Y2028D13Tests
{
    private readonly Y2028D13 _challenge = new Y2028D13();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D13\Y2028D13-input.txt", Encoding.UTF8);
