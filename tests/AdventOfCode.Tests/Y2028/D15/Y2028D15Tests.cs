...
public class Y2028D15Tests
{
    private readonly Y2028D15 _challenge = new Y2028D15();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D15\Y2028D15-input.txt", Encoding.UTF8);
