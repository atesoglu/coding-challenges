...
namespace AdventOfCode.Tests.Y2028.D01;

public class Y2028D01Tests
{
    private readonly Y2028D01 _challenge = new Y2028D01();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D01\Y2028D01-input.txt", Encoding.UTF8);
