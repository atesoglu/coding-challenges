...
public class Y2028D09Tests
{
    private readonly Y2028D09 _challenge = new Y2028D09();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D09\Y2028D09-input.txt", Encoding.UTF8);
