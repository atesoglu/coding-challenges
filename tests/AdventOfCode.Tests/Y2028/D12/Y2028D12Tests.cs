...
public class Y2028D12Tests
{
    private readonly Y2028D12 _challenge = new Y2028D12();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D12\Y2028D12-input.txt", Encoding.UTF8);
