...
public class Y2028D25Tests
{
    private readonly Y2028D25 _challenge = new Y2028D25();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D25\Y2028D25-input.txt", Encoding.UTF8);
