...
public class Y2028D18Tests
{
    private readonly Y2028D18 _challenge = new Y2028D18();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D18\Y2028D18-input.txt", Encoding.UTF8);
