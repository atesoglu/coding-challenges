...
public class Y2028D17Tests
{
    private readonly Y2028D17 _challenge = new Y2028D17();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D17\Y2028D17-input.txt", Encoding.UTF8);
