...
public class Y2028D14Tests
{
    private readonly Y2028D14 _challenge = new Y2028D14();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D14\Y2028D14-input.txt", Encoding.UTF8);
