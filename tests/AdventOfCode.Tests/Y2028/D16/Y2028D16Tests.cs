...
public class Y2028D16Tests
{
    private readonly Y2028D16 _challenge = new Y2028D16();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D16\Y2028D16-input.txt", Encoding.UTF8);
