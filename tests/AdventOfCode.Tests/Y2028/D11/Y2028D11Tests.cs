...
public class Y2028D11Tests
{
    private readonly Y2028D11 _challenge = new Y2028D11();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D11\Y2028D11-input.txt", Encoding.UTF8);
