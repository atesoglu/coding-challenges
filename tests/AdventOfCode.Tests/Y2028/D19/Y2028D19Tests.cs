...
namespace AdventOfCode.Tests.Y2028.D19;

public class Y2028D19Tests
{
    private readonly Y2028D19 _challenge = new Y2028D19();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D19\Y2028D19-input.txt", Encoding.UTF8);
