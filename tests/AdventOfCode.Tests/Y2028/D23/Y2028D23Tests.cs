...
public class Y2028D23Tests
{
    private readonly Y2028D23 _challenge = new Y2028D23();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D23\Y2028D23-input.txt", Encoding.UTF8);
