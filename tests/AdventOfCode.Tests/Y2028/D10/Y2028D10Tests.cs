...
public class Y2028D10Tests
{
    private readonly Y2028D10 _challenge = new Y2028D10();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D10\Y2028D10-input.txt", Encoding.UTF8);
