...
public class Y2028D20Tests
{
    private readonly Y2028D20 _challenge = new Y2028D20();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D20\Y2028D20-input.txt", Encoding.UTF8);
