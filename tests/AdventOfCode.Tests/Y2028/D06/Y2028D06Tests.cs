...
namespace AdventOfCode.Tests.Y2028.D06;

public class Y2028D06Tests
{
    private readonly Y2028D06 _challenge = new Y2028D06();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D06\Y2028D06-input.txt", Encoding.UTF8);
