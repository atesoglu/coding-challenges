...
public class Y2028D07Tests
{
    private readonly Y2028D07 _challenge = new Y2028D07();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D07\Y2028D07-input.txt", Encoding.UTF8);
