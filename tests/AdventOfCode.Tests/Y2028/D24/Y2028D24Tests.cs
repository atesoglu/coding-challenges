...
public class Y2028D24Tests
{
    private readonly Y2028D24 _challenge = new Y2028D24();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D24\Y2028D24-input.txt", Encoding.UTF8);
