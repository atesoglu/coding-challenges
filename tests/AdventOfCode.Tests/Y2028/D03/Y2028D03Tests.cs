...
public class Y2028D03Tests
{
    private readonly Y2028D03 _challenge = new Y2028D03();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D03\Y2028D03-input.txt", Encoding.UTF8);
