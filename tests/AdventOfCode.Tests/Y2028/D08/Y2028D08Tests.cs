...
namespace AdventOfCode.Tests.Y2028.D08;

public class Y2028D08Tests
{
    private readonly Y2028D08 _challenge = new Y2028D08();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D08\Y2028D08-input.txt", Encoding.UTF8);
