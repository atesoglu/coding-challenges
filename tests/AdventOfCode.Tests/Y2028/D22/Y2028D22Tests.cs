...
namespace AdventOfCode.Tests.Y2028.D22;

public class Y2028D22Tests
{
    private readonly Y2028D22 _challenge = new Y2028D22();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D22\Y2028D22-input.txt", Encoding.UTF8);
