...
namespace AdventOfCode.Tests.Y2028.D02;

public class Y2028D02Tests
{
    private readonly Y2028D02 _challenge = new Y2028D02();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2028\D02\Y2028D02-input.txt", Encoding.UTF8);
