...
public class Y2018D19Tests
{
    private readonly Y2018D19 _challenge = new Y2018D19();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D19\Y2018D19-input.txt", Encoding.UTF8);
