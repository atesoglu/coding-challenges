...
public class Y2018D15Tests
{
    private readonly Y2018D15 _challenge = new Y2018D15();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D15\Y2018D15-input.txt", Encoding.UTF8);
