...
public class Y2018D16Tests
{
    private readonly Y2018D16 _challenge = new Y2018D16();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D16\Y2018D16-input.txt", Encoding.UTF8);
