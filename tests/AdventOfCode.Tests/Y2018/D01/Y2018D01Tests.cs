...
public class Y2018D01Tests
{
    private readonly Y2018D01 _challenge = new Y2018D01();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D01\Y2018D01-input.txt", Encoding.UTF8);
