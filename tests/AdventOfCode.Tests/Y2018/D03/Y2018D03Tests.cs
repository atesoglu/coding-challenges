...
public class Y2018D03Tests
{
    private readonly Y2018D03 _challenge = new Y2018D03();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D03\Y2018D03-input.txt", Encoding.UTF8);
