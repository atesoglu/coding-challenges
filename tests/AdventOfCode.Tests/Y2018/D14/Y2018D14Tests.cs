...
public class Y2018D14Tests
{
    private readonly Y2018D14 _challenge = new Y2018D14();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D14\Y2018D14-input.txt", Encoding.UTF8);
