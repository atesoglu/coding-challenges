...
public class Y2018D20Tests
{
    private readonly Y2018D20 _challenge = new Y2018D20();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D20\Y2018D20-input.txt", Encoding.UTF8);
