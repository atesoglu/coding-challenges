...
public class Y2018D25Tests
{
    private readonly Y2018D25 _challenge = new Y2018D25();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D25\Y2018D25-input.txt", Encoding.UTF8);
