...
public class Y2018D06Tests
{
    private readonly Y2018D06 _challenge = new Y2018D06();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D06\Y2018D06-input.txt", Encoding.UTF8);
