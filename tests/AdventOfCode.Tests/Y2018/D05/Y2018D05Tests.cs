...
public class Y2018D05Tests
{
    private readonly Y2018D05 _challenge = new Y2018D05();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D05\Y2018D05-input.txt", Encoding.UTF8);
