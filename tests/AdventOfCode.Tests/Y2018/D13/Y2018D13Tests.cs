...
public class Y2018D13Tests
{
    private readonly Y2018D13 _challenge = new Y2018D13();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D13\Y2018D13-input.txt", Encoding.UTF8);
