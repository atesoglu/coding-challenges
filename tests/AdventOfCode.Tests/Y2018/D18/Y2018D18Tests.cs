...
public class Y2018D18Tests
{
    private readonly Y2018D18 _challenge = new Y2018D18();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D18\Y2018D18-input.txt", Encoding.UTF8);
