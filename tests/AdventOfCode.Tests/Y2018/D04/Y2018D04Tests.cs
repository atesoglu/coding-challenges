...
public class Y2018D04Tests
{
    private readonly Y2018D04 _challenge = new Y2018D04();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D04\Y2018D04-input.txt", Encoding.UTF8);
