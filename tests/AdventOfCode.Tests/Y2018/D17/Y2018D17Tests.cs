...
public class Y2018D17Tests
{
    private readonly Y2018D17 _challenge = new Y2018D17();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D17\Y2018D17-input.txt", Encoding.UTF8);
