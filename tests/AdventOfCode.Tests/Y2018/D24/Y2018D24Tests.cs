...
public class Y2018D24Tests
{
    private readonly Y2018D24 _challenge = new Y2018D24();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D24\Y2018D24-input.txt", Encoding.UTF8);
