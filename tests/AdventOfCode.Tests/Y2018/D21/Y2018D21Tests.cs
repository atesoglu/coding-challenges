...
public class Y2018D21Tests
{
    private readonly Y2018D21 _challenge = new Y2018D21();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D21\Y2018D21-input.txt", Encoding.UTF8);
