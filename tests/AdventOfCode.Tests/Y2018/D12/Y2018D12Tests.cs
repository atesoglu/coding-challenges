...
public class Y2018D12Tests
{
    private readonly Y2018D12 _challenge = new Y2018D12();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D12\Y2018D12-input.txt", Encoding.UTF8);
