...
public class Y2018D02Tests
{
    private readonly Y2018D02 _challenge = new Y2018D02();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D02\Y2018D02-input.txt", Encoding.UTF8);
