...
public class Y2018D07Tests
{
    private readonly Y2018D07 _challenge = new Y2018D07();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D07\Y2018D07-input.txt", Encoding.UTF8);
