...
public class Y2018D11Tests
{
    private readonly Y2018D11 _challenge = new Y2018D11();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D11\Y2018D11-input.txt", Encoding.UTF8);
