...
namespace AdventOfCode.Tests.Y2018.D11;

[ChallengeName("Chronal Charge")]
public class Y2018D11
{
    private readonly string _input = File.ReadAllText(@"Y2018\D11\Y2018D11-input.txt", Encoding.UTF8);
    ...
    private static (int xMax, int yMax, int dMax) Solver(int gridSerialNumber, int D)
    {
