...
public class Y2018D10Tests
{
    private readonly Y2018D10 _challenge = new Y2018D10();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D10\Y2018D10-input.txt", Encoding.UTF8);
