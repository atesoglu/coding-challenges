...
public class Y2018D23Tests
{
    private readonly Y2018D23 _challenge = new Y2018D23();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D23\Y2018D23-input.txt", Encoding.UTF8);
