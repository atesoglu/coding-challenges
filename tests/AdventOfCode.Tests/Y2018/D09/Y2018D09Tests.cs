...
public class Y2018D09Tests
{
    private readonly Y2018D09 _challenge = new Y2018D09();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D09\Y2018D09-input.txt", Encoding.UTF8);
