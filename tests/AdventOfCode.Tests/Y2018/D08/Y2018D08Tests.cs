...
public class Y2018D08Tests
{
    private readonly Y2018D08 _challenge = new Y2018D08();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2018\D08\Y2018D08-input.txt", Encoding.UTF8);
