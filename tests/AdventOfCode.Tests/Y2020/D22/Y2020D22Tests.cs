...
namespace AdventOfCode.Tests.Y2020.D22;

public class Y2020D22Tests
{
    private readonly Y2020D22 _challenge = new Y2020D22();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D22\Y2020D22-input.txt", Encoding.UTF8);
