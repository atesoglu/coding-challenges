...
[ChallengeName("Crab Combat")]
public class Y2020D22
{
    private readonly string _input = File.ReadAllText(@"Y2020\D22\Y2020D22-input.txt", Encoding.UTF8);
    ...
    private static int Answer(Queue<int> deck1, Queue<int> deck2) =>
