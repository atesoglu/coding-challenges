...
public class Y2020D24Tests
{
    private readonly Y2020D24 _challenge = new Y2020D24();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D24\Y2020D24-input.txt", Encoding.UTF8);
