...
public class Y2020D14Tests
{
    private readonly Y2020D14 _challenge = new Y2020D14();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D14\Y2020D14-input.txt", Encoding.UTF8);
