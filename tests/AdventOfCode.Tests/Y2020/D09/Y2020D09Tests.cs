...
public class Y2020D09Tests
{
    private readonly Y2020D09 _challenge = new Y2020D09();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D09\Y2020D09-input.txt", Encoding.UTF8);
