...
public class Y2020D08Tests
{
    private readonly Y2020D08 _challenge = new Y2020D08();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D08\Y2020D08-input.txt", Encoding.UTF8);
