...
public class Y2020D07Tests
{
    private readonly Y2020D07 _challenge = new Y2020D07();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D07\Y2020D07-input.txt", Encoding.UTF8);
