...
public class Y2020D13Tests
{
    private readonly Y2020D13 _challenge = new Y2020D13();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D13\Y2020D13-input.txt", Encoding.UTF8);
