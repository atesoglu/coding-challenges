...
public class Y2020D16Tests
{
    private readonly Y2020D16 _challenge = new Y2020D16();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D16\Y2020D16-input.txt", Encoding.UTF8);
