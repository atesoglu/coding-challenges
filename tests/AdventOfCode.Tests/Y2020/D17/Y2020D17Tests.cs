...
public class Y2020D17Tests
{
    private readonly Y2020D17 _challenge = new Y2020D17();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D17\Y2020D17-input.txt", Encoding.UTF8);
