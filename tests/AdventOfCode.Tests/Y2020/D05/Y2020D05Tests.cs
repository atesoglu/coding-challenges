...
public class Y2020D05Tests
{
    private readonly Y2020D05 _challenge = new Y2020D05();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D05\Y2020D05-input.txt", Encoding.UTF8);
