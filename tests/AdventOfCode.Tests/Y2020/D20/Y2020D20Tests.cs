...
namespace AdventOfCode.Tests.Y2020.D20;

public class Y2020D20Tests
{
    private readonly Y2020D20 _challenge = new Y2020D20();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D20\Y2020D20-input.txt", Encoding.UTF8);
