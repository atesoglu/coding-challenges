...
public class Y2020D15Tests
{
    private readonly Y2020D15 _challenge = new Y2020D15();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D15\Y2020D15-input.txt", Encoding.UTF8);
