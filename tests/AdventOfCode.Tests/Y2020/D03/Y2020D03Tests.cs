...
public class Y2020D03Tests
{
    private readonly Y2020D03 _challenge = new Y2020D03();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D03\Y2020D03-input.txt", Encoding.UTF8);
