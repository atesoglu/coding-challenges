...
public class Y2020D02Tests
{
    private readonly Y2020D02 _challenge = new Y2020D02();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D02\Y2020D02-input.txt", Encoding.UTF8);
