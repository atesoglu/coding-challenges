...
public class Y2020D18Tests
{
    private readonly Y2020D18 _challenge = new Y2020D18();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D18\Y2020D18-input.txt", Encoding.UTF8);
