...
public class Y2020D11Tests
{
    private readonly Y2020D11 _challenge = new Y2020D11();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D11\Y2020D11-input.txt", Encoding.UTF8);
