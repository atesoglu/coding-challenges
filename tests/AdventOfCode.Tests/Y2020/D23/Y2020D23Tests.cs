...
public class Y2020D23Tests
{
    private readonly Y2020D23 _challenge = new Y2020D23();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D23\Y2020D23-input.txt", Encoding.UTF8);
