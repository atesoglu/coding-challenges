...
public class Y2020D01Tests
{
    private readonly Y2020D01 _challenge = new Y2020D01();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D01\Y2020D01-input.txt", Encoding.UTF8);
