...
public class Y2020D21Tests
{
    private readonly Y2020D21 _challenge = new Y2020D21();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D21\Y2020D21-input.txt", Encoding.UTF8);
