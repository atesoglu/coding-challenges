...
namespace AdventOfCode.Tests.Y2020.D19;

public class Y2020D19Tests
{
    private readonly Y2020D19 _challenge = new Y2020D19();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D19\Y2020D19-input.txt", Encoding.UTF8);
