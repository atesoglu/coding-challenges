...
public class Y2020D12Tests
{
    private readonly Y2020D12 _challenge = new Y2020D12();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D12\Y2020D12-input.txt", Encoding.UTF8);
