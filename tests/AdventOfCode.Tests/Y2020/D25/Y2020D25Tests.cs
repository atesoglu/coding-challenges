...
public class Y2020D25Tests
{
    private readonly Y2020D25 _challenge = new Y2020D25();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D25\Y2020D25-input.txt", Encoding.UTF8);
