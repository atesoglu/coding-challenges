...
public class Y2020D06Tests
{
    private readonly Y2020D06 _challenge = new Y2020D06();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D06\Y2020D06-input.txt", Encoding.UTF8);
