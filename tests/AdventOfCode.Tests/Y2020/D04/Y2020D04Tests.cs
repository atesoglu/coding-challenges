...
public class Y2020D04Tests
{
    private readonly Y2020D04 _challenge = new Y2020D04();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D04\Y2020D04-input.txt", Encoding.UTF8);
