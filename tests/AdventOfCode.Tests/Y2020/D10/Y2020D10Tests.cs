...
public class Y2020D10Tests
{
    private readonly Y2020D10 _challenge = new Y2020D10();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2020\D10\Y2020D10-input.txt", Encoding.UTF8);
