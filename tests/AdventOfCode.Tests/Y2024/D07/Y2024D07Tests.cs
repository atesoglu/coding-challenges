...
public class Y2024D07Tests
{
    private readonly Y2024D07 _challenge = new Y2024D07();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D07\Y2024D07-input.txt", Encoding.UTF8);
