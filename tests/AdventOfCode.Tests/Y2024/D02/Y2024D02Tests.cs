...
public class Y2024D02Tests
{
    private readonly Y2024D02 _challenge = new Y2024D02();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D02\Y2024D02-input.txt", Encoding.UTF8);
