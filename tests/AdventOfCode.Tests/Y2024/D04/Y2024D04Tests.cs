...
public class Y2024D04Tests
{
    private readonly Y2024D04 _challenge = new Y2024D04();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D04\Y2024D04-input.txt", Encoding.UTF8);
