...
public class Y2024D06Tests
{
    private readonly Y2024D06 _challenge = new Y2024D06();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D06\Y2024D06-input.txt", Encoding.UTF8);
