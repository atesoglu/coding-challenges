...
public class Y2024D15Tests
{
    private readonly Y2024D15 _challenge = new Y2024D15();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D15\Y2024D15-input.txt", Encoding.UTF8);
