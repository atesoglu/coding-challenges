...
public class Y2024D05Tests
{
    private readonly Y2024D05 _challenge = new Y2024D05();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D05\Y2024D05-input.txt", Encoding.UTF8);
