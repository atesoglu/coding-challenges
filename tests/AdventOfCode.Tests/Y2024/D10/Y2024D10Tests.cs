...
public class Y2024D10Tests
{
    private readonly Y2024D10 _challenge = new Y2024D10();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D10\Y2024D10-input.txt", Encoding.UTF8);
