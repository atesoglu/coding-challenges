...
public class Y2024D25Tests
{
    private readonly Y2024D25 _challenge = new Y2024D25();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D25\Y2024D25-input.txt", Encoding.UTF8);
