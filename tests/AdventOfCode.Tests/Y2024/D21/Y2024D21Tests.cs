...
public class Y2024D21Tests
{
    private readonly Y2024D21 _challenge = new Y2024D21();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D21\Y2024D21-input.txt", Encoding.UTF8);
