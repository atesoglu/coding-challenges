...
public class Y2024D17Tests
{
    private readonly Y2024D17 _challenge = new Y2024D17();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D17\Y2024D17-input.txt", Encoding.UTF8);
