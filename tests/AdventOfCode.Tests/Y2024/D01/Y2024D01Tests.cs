...
public class Y2024D01Tests
{
    private readonly Y2024D01 _challenge = new Y2024D01();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D01\Y2024D01-input.txt", Encoding.UTF8);
