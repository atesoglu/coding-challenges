...
public class Y2024D08Tests
{
    private readonly Y2024D08 _challenge = new Y2024D08();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D08\Y2024D08-input.txt", Encoding.UTF8);
