...
public class Y2024D12Tests
{
    private readonly Y2024D12 _challenge = new Y2024D12();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D12\Y2024D12-input.txt", Encoding.UTF8);
