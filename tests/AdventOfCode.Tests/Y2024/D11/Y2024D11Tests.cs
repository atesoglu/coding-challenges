...
public class Y2024D11Tests
{
    private readonly Y2024D11 _challenge = new Y2024D11();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D11\Y2024D11-input.txt", Encoding.UTF8);
