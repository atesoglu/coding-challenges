...
public class Y2024D18Tests
{
    private readonly Y2024D18 _challenge = new Y2024D18();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D18\Y2024D18-input.txt", Encoding.UTF8);
