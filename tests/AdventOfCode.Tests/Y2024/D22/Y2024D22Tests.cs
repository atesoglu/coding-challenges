...
public class Y2024D22Tests
{
    private readonly Y2024D22 _challenge = new Y2024D22();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D22\Y2024D22-input.txt", Encoding.UTF8);
