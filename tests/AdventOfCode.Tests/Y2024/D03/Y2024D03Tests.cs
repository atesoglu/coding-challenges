...
public class Y2024D03Tests
{
    private readonly Y2024D03 _challenge = new Y2024D03();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D03\Y2024D03-input.txt", Encoding.UTF8);
