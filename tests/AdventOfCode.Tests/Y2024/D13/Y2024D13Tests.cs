...
public class Y2024D13Tests
{
    private readonly Y2024D13 _challenge = new Y2024D13();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D13\Y2024D13-input.txt", Encoding.UTF8);
