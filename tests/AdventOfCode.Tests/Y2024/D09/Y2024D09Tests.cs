...
public class Y2024D09Tests
{
    private readonly Y2024D09 _challenge = new Y2024D09();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D09\Y2024D09-input.txt", Encoding.UTF8);
