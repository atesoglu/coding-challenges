...
public class Y2024D23Tests
{
    private readonly Y2024D23 _challenge = new Y2024D23();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D23\Y2024D23-input.txt", Encoding.UTF8);
