...
public class Y2024D16Tests
{
    private readonly Y2024D16 _challenge = new Y2024D16();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D16\Y2024D16-input.txt", Encoding.UTF8);
