...
public class Y2024D19Tests
{
    private readonly Y2024D19 _challenge = new Y2024D19();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D19\Y2024D19-input.txt", Encoding.UTF8);
