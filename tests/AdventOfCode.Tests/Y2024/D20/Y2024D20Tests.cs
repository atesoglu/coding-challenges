...
public class Y2024D20Tests
{
    private readonly Y2024D20 _challenge = new Y2024D20();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D20\Y2024D20-input.txt", Encoding.UTF8);
