...
public class Y2024D24Tests
{
    private readonly Y2024D24 _challenge = new Y2024D24();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D24\Y2024D24-input.txt", Encoding.UTF8);
