...
public class Y2024D14Tests
{
    private readonly Y2024D14 _challenge = new Y2024D14();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2024\D14\Y2024D14-input.txt", Encoding.UTF8);
