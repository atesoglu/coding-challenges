...
public class Y2025D25Tests
{
    private readonly Y2025D25 _challenge = new Y2025D25();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D25\Y2025D25-input.txt", Encoding.UTF8);
