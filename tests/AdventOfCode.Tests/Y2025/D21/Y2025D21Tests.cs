...
namespace AdventOfCode.Tests.Y2025.D21;

public class Y2025D21Tests
{
    private readonly Y2025D21 _challenge = new Y2025D21();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D21\Y2025D21-input.txt", Encoding.UTF8);
