...
public class Y2025D02Tests
{
    private readonly Y2025D02 _challenge = new Y2025D02();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D02\Y2025D02-input.txt", Encoding.UTF8);
