...
public class Y2025D10Tests
{
    private readonly Y2025D10 _challenge = new Y2025D10();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D10\Y2025D10-input.txt", Encoding.UTF8);
