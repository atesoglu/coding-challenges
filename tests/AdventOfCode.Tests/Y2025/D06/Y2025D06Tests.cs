...
public class Y2025D06Tests
{
    private readonly Y2025D06 _challenge = new Y2025D06();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D06\Y2025D06-input.txt", Encoding.UTF8);
