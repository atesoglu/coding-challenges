...
namespace AdventOfCode.Tests.Y2025.D15;

public class Y2025D15Tests
{
    private readonly Y2025D15 _challenge = new Y2025D15();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D15\Y2025D15-input.txt", Encoding.UTF8);
