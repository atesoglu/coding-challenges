...
public class Y2025D12Tests
{
    private readonly Y2025D12 _challenge = new Y2025D12();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D12\Y2025D12-input.txt", Encoding.UTF8);
