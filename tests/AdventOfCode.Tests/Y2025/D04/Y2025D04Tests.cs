...
public class Y2025D04Tests
{
    private readonly Y2025D04 _challenge = new Y2025D04();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D04\Y2025D04-input.txt", Encoding.UTF8);
