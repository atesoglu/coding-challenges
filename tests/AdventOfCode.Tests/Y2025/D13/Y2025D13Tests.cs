...
namespace AdventOfCode.Tests.Y2025.D13;

public class Y2025D13Tests
{
    private readonly Y2025D13 _challenge = new Y2025D13();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D13\Y2025D13-input.txt", Encoding.UTF8);
