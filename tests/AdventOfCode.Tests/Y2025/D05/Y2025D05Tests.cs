...
public class Y2025D05Tests
{
    private readonly Y2025D05 _challenge = new Y2025D05();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D05\Y2025D05-input.txt", Encoding.UTF8);
