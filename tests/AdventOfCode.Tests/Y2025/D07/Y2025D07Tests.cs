...
public class Y2025D07Tests
{
    private readonly Y2025D07 _challenge = new Y2025D07();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D07\Y2025D07-input.txt", Encoding.UTF8);
