...
namespace AdventOfCode.Tests.Y2025.D24;

public class Y2025D24Tests
{
    private readonly Y2025D24 _challenge = new Y2025D24();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D24\Y2025D24-input.txt", Encoding.UTF8);
