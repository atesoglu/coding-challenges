...
public class Y2025D03Tests
{
    private readonly Y2025D03 _challenge = new Y2025D03();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D03\Y2025D03-input.txt", Encoding.UTF8);
