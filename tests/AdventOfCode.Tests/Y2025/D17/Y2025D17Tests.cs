...
namespace AdventOfCode.Tests.Y2025.D17;

public class Y2025D17Tests
{
    private readonly Y2025D17 _challenge = new Y2025D17();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D17\Y2025D17-input.txt", Encoding.UTF8);
