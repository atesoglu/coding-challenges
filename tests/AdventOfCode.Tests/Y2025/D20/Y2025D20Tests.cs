...
namespace AdventOfCode.Tests.Y2025.D20;

public class Y2025D20Tests
{
    private readonly Y2025D20 _challenge = new Y2025D20();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D20\Y2025D20-input.txt", Encoding.UTF8);
