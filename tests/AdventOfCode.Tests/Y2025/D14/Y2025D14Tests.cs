...
namespace AdventOfCode.Tests.Y2025.D14;

public class Y2025D14Tests
{
    private readonly Y2025D14 _challenge = new Y2025D14();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D14\Y2025D14-input.txt", Encoding.UTF8);
