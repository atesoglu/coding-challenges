...
public class Y2025D09Tests
{
    private readonly Y2025D09 _challenge = new Y2025D09();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D09\Y2025D09-input.txt", Encoding.UTF8);
