...
public class Y2025D08Tests
{
    private readonly Y2025D08 _challenge = new Y2025D08();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D08\Y2025D08-input.txt", Encoding.UTF8);
