...
public class Y2025D01Tests
{
    private readonly Y2025D01 _challenge = new Y2025D01();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D01\Y2025D01-input.txt", Encoding.UTF8);
