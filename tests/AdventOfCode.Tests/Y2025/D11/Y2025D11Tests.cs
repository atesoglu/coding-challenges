...
public class Y2025D11Tests
{
    private readonly Y2025D11 _challenge = new Y2025D11();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D11\Y2025D11-input.txt", Encoding.UTF8);
