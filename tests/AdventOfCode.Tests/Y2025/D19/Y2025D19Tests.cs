...
namespace AdventOfCode.Tests.Y2025.D19;

public class Y2025D19Tests
{
    private readonly Y2025D19 _challenge = new Y2025D19();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D19\Y2025D19-input.txt", Encoding.UTF8);
