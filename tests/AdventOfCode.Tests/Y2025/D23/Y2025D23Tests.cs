...
namespace AdventOfCode.Tests.Y2025.D23;

public class Y2025D23Tests
{
    private readonly Y2025D23 _challenge = new Y2025D23();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D23\Y2025D23-input.txt", Encoding.UTF8);
