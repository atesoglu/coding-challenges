...
namespace AdventOfCode.Tests.Y2025.D16;

public class Y2025D16Tests
{
    private readonly Y2025D16 _challenge = new Y2025D16();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D16\Y2025D16-input.txt", Encoding.UTF8);
