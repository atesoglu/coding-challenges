...
namespace AdventOfCode.Tests.Y2025.D22;

public class Y2025D22Tests
{
    private readonly Y2025D22 _challenge = new Y2025D22();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D22\Y2025D22-input.txt", Encoding.UTF8);
