...
namespace AdventOfCode.Tests.Y2025.D18;

public class Y2025D18Tests
{
    private readonly Y2025D18 _challenge = new Y2025D18();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2025\D18\Y2025D18-input.txt", Encoding.UTF8);
