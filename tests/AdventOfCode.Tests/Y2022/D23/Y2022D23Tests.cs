...
public class Y2022D23Tests
{
    private readonly Y2022D23 _challenge = new Y2022D23();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D23\Y2022D23-input.txt", Encoding.UTF8);
