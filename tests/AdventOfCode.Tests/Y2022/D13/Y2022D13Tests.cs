...
public class Y2022D13Tests
{
    private readonly Y2022D13 _challenge = new Y2022D13();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D13\Y2022D13-input.txt", Encoding.UTF8);
