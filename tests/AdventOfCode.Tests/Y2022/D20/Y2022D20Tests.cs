...
public class Y2022D20Tests
{
    private readonly Y2022D20 _challenge = new Y2022D20();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D20\Y2022D20-input.txt", Encoding.UTF8);
