...
public class Y2022D18Tests
{
    private readonly Y2022D18 _challenge = new Y2022D18();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D18\Y2022D18-input.txt", Encoding.UTF8);
