...
public class Y2022D21Tests
{
    private readonly Y2022D21 _challenge = new Y2022D21();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D21\Y2022D21-input.txt", Encoding.UTF8);
