...
public class Y2022D01Tests
{
    private readonly Y2022D01 _challenge = new Y2022D01();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D01\Y2022D01-input.txt", Encoding.UTF8);
