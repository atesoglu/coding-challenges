...
public class Y2022D24Tests
{
    private readonly Y2022D24 _challenge = new Y2022D24();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D24\Y2022D24-input.txt", Encoding.UTF8);
