...
public class Y2022D16Tests
{
    private readonly Y2022D16 _challenge = new Y2022D16();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D16\Y2022D16-input.txt", Encoding.UTF8);
