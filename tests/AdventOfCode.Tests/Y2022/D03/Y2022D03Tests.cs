...
public class Y2022D03Tests
{
    private readonly Y2022D03 _challenge = new Y2022D03();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D03\Y2022D03-input.txt", Encoding.UTF8);
