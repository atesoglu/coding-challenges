...
public class Y2022D04Tests
{
    private readonly Y2022D04 _challenge = new Y2022D04();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D04\Y2022D04-input.txt", Encoding.UTF8);
