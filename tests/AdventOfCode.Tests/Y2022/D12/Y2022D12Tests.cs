...
public class Y2022D12Tests
{
    private readonly Y2022D12 _challenge = new Y2022D12();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D12\Y2022D12-input.txt", Encoding.UTF8);
