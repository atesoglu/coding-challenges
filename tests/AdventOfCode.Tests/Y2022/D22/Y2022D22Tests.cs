...
namespace AdventOfCode.Tests.Y2022.D22;

public class Y2022D22Tests
{
    private readonly Y2022D22 _challenge = new Y2022D22();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D22\Y2022D22-input.txt", Encoding.UTF8);
