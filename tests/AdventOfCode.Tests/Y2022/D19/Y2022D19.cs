...
namespace AdventOfCode.Tests.Y2022.D19;

[ChallengeName("Not Enough Minerals")]
public class Y2022D19
{
    private readonly string _input = File.ReadAllText(@"Y2022\D19\Y2022D19-input.txt", Encoding.UTF8);

    [Fact]
    public void PartOne()
    {
        var res = 0;
        foreach (var blueprint in Parse(_input).Where(bp => bp.id < 100))
        {
