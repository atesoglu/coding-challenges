...
public class Y2022D19Tests
{
    private readonly Y2022D19 _challenge = new Y2022D19();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D19\Y2022D19-input.txt", Encoding.UTF8);
