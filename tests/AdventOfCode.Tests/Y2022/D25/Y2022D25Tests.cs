...
public class Y2022D25Tests
{
    private readonly Y2022D25 _challenge = new Y2022D25();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D25\Y2022D25-input.txt", Encoding.UTF8);
