...
public class Y2022D02Tests
{
    private readonly Y2022D02 _challenge = new Y2022D02();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D02\Y2022D02-input.txt", Encoding.UTF8);
