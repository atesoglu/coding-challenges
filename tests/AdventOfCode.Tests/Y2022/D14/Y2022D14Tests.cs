...
public class Y2022D14Tests
{
    private readonly Y2022D14 _challenge = new Y2022D14();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D14\Y2022D14-input.txt", Encoding.UTF8);
