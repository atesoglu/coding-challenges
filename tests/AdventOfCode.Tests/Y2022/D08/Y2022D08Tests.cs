...
public class Y2022D08Tests
{
    private readonly Y2022D08 _challenge = new Y2022D08();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D08\Y2022D08-input.txt", Encoding.UTF8);
