...
public class Y2022D10Tests
{
    private readonly Y2022D10 _challenge = new Y2022D10();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D10\Y2022D10-input.txt", Encoding.UTF8);
