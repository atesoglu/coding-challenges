...
public class Y2022D05Tests
{
    private readonly Y2022D05 _challenge = new Y2022D05();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D05\Y2022D05-input.txt", Encoding.UTF8);
