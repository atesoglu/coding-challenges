...
public class Y2022D17Tests
{
    private readonly Y2022D17 _challenge = new Y2022D17();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D17\Y2022D17-input.txt", Encoding.UTF8);
