...
namespace AdventOfCode.Tests.Y2022.D15;

public class Y2022D15Tests
{
    private readonly Y2022D15 _challenge = new Y2022D15();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D15\Y2022D15-input.txt", Encoding.UTF8);
