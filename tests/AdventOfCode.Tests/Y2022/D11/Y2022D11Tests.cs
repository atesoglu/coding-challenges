...
public class Y2022D11Tests
{
    private readonly Y2022D11 _challenge = new Y2022D11();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D11\Y2022D11-input.txt", Encoding.UTF8);
