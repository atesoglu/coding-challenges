...
public class Y2022D07Tests
{
    private readonly Y2022D07 _challenge = new Y2022D07();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D07\Y2022D07-input.txt", Encoding.UTF8);
