...
[ChallengeName("Rope Bridge")]
public class Y2022D09
{
    private readonly string _input = File.ReadAllText(@"Y2022\D09\Y2022D09-input.txt", Encoding.UTF8);
    ...
    private record struct Knot(int irow, int icol);
