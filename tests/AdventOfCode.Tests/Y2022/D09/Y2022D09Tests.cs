...
namespace AdventOfCode.Tests.Y2022.D09;

public class Y2022D09Tests
{
    private readonly Y2022D09 _challenge = new Y2022D09();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D09\Y2022D09-input.txt", Encoding.UTF8);
