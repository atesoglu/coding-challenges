...
public class Y2022D06Tests
{
    private readonly Y2022D06 _challenge = new Y2022D06();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2022\D06\Y2022D06-input.txt", Encoding.UTF8);
