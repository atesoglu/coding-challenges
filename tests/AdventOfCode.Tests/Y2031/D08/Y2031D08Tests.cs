...
namespace AdventOfCode.Tests.Y2031.D08;

public class Y2031D08Tests
{
    private readonly Y2031D08 _challenge = new Y2031D08();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D08\Y2031D08-input.txt", Encoding.UTF8);
