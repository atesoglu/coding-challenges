...
namespace AdventOfCode.Tests.Y2031.D18;

public class Y2031D18Tests
{
    private readonly Y2031D18 _challenge = new Y2031D18();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D18\Y2031D18-input.txt", Encoding.UTF8);
