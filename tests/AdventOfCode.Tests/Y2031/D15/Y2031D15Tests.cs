...
namespace AdventOfCode.Tests.Y2031.D15;

public class Y2031D15Tests
{
    private readonly Y2031D15 _challenge = new Y2031D15();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D15\Y2031D15-input.txt", Encoding.UTF8);
