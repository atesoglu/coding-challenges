...
namespace AdventOfCode.Tests.Y2031.D05;

public class Y2031D05Tests
{
    private readonly Y2031D05 _challenge = new Y2031D05();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D05\Y2031D05-input.txt", Encoding.UTF8);
