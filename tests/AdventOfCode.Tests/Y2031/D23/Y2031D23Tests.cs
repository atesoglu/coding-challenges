...
namespace AdventOfCode.Tests.Y2031.D23;

public class Y2031D23Tests
{
    private readonly Y2031D23 _challenge = new Y2031D23();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D23\Y2031D23-input.txt", Encoding.UTF8);
