...
namespace AdventOfCode.Tests.Y2031.D25;

public class Y2031D25Tests
{
    private readonly Y2031D25 _challenge = new Y2031D25();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D25\Y2031D25-input.txt", Encoding.UTF8);
