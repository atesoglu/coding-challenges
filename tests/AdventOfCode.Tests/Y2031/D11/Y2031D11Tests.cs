...
namespace AdventOfCode.Tests.Y2031.D11;

public class Y2031D11Tests
{
    private readonly Y2031D11 _challenge = new Y2031D11();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D11\Y2031D11-input.txt", Encoding.UTF8);
