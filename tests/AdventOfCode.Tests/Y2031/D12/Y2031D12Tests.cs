...
namespace AdventOfCode.Tests.Y2031.D12;

public class Y2031D12Tests
{
    private readonly Y2031D12 _challenge = new Y2031D12();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D12\Y2031D12-input.txt", Encoding.UTF8);
