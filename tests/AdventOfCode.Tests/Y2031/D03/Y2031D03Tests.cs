...
namespace AdventOfCode.Tests.Y2031.D03;

public class Y2031D03Tests
{
    private readonly Y2031D03 _challenge = new Y2031D03();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D03\Y2031D03-input.txt", Encoding.UTF8);
