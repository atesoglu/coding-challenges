...
namespace AdventOfCode.Tests.Y2031.D13;

public class Y2031D13Tests
{
    private readonly Y2031D13 _challenge = new Y2031D13();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D13\Y2031D13-input.txt", Encoding.UTF8);
