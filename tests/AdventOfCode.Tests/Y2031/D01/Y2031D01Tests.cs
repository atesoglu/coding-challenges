...
namespace AdventOfCode.Tests.Y2031.D01;

public class Y2031D01Tests
{
    private readonly Y2031D01 _challenge = new Y2031D01();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D01\Y2031D01-input.txt", Encoding.UTF8);
