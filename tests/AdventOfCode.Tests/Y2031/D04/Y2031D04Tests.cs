...
namespace AdventOfCode.Tests.Y2031.D04;

public class Y2031D04Tests
{
    private readonly Y2031D04 _challenge = new Y2031D04();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D04\Y2031D04-input.txt", Encoding.UTF8);
