...
namespace AdventOfCode.Tests.Y2031.D02;

public class Y2031D02Tests
{
    private readonly Y2031D02 _challenge = new Y2031D02();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D02\Y2031D02-input.txt", Encoding.UTF8);
