...
namespace AdventOfCode.Tests.Y2031.D21;

public class Y2031D21Tests
{
    private readonly Y2031D21 _challenge = new Y2031D21();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D21\Y2031D21-input.txt", Encoding.UTF8);
