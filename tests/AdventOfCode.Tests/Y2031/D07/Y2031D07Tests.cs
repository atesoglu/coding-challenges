...
namespace AdventOfCode.Tests.Y2031.D07;

public class Y2031D07Tests
{
    private readonly Y2031D07 _challenge = new Y2031D07();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D07\Y2031D07-input.txt", Encoding.UTF8);
