...
namespace AdventOfCode.Tests.Y2031.D16;

public class Y2031D16Tests
{
    private readonly Y2031D16 _challenge = new Y2031D16();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D16\Y2031D16-input.txt", Encoding.UTF8);
