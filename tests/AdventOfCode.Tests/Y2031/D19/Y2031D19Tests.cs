...
namespace AdventOfCode.Tests.Y2031.D19;

public class Y2031D19Tests
{
    private readonly Y2031D19 _challenge = new Y2031D19();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D19\Y2031D19-input.txt", Encoding.UTF8);
