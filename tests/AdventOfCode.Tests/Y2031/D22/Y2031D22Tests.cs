...
namespace AdventOfCode.Tests.Y2031.D22;

public class Y2031D22Tests
{
    private readonly Y2031D22 _challenge = new Y2031D22();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D22\Y2031D22-input.txt", Encoding.UTF8);
