...
namespace AdventOfCode.Tests.Y2031.D17;

public class Y2031D17Tests
{
    private readonly Y2031D17 _challenge = new Y2031D17();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D17\Y2031D17-input.txt", Encoding.UTF8);
