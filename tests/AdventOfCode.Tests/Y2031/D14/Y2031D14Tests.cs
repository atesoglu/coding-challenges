...
namespace AdventOfCode.Tests.Y2031.D14;

public class Y2031D14Tests
{
    private readonly Y2031D14 _challenge = new Y2031D14();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D14\Y2031D14-input.txt", Encoding.UTF8);
