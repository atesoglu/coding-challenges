...
namespace AdventOfCode.Tests.Y2031.D10;

public class Y2031D10Tests
{
    private readonly Y2031D10 _challenge = new Y2031D10();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D10\Y2031D10-input.txt", Encoding.UTF8);
