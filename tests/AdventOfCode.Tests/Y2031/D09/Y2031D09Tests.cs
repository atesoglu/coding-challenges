...
namespace AdventOfCode.Tests.Y2031.D09;

public class Y2031D09Tests
{
    private readonly Y2031D09 _challenge = new Y2031D09();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D09\Y2031D09-input.txt", Encoding.UTF8);
