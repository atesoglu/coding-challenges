...
namespace AdventOfCode.Tests.Y2031.D06;

public class Y2031D06Tests
{
    private readonly Y2031D06 _challenge = new Y2031D06();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D06\Y2031D06-input.txt", Encoding.UTF8);
