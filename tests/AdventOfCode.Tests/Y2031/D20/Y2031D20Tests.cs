...
namespace AdventOfCode.Tests.Y2031.D20;

public class Y2031D20Tests
{
    private readonly Y2031D20 _challenge = new Y2031D20();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D20\Y2031D20-input.txt", Encoding.UTF8);
