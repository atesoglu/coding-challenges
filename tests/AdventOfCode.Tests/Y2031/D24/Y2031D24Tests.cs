...
namespace AdventOfCode.Tests.Y2031.D24;

public class Y2031D24Tests
{
    private readonly Y2031D24 _challenge = new Y2031D24();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2031\D24\Y2031D24-input.txt", Encoding.UTF8);
