...
namespace AdventOfCode.Tests.Y2030.D19;

public class Y2030D19Tests
{
    private readonly Y2030D19 _challenge = new Y2030D19();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D19\Y2030D19-input.txt", Encoding.UTF8);
