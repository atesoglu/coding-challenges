...
namespace AdventOfCode.Tests.Y2030.D07;

public class Y2030D07Tests
{
    private readonly Y2030D07 _challenge = new Y2030D07();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D07\Y2030D07-input.txt", Encoding.UTF8);
