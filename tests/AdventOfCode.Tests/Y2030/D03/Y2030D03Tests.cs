...
namespace AdventOfCode.Tests.Y2030.D03;

public class Y2030D03Tests
{
    private readonly Y2030D03 _challenge = new Y2030D03();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D03\Y2030D03-input.txt", Encoding.UTF8);
