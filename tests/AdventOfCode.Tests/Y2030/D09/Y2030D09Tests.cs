...
namespace AdventOfCode.Tests.Y2030.D09;

public class Y2030D09Tests
{
    private readonly Y2030D09 _challenge = new Y2030D09();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D09\Y2030D09-input.txt", Encoding.UTF8);
