...
namespace AdventOfCode.Tests.Y2030.D06;

public class Y2030D06Tests
{
    private readonly Y2030D06 _challenge = new Y2030D06();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D06\Y2030D06-input.txt", Encoding.UTF8);
