...
namespace AdventOfCode.Tests.Y2030.D22;

public class Y2030D22Tests
{
    private readonly Y2030D22 _challenge = new Y2030D22();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D22\Y2030D22-input.txt", Encoding.UTF8);
