...
namespace AdventOfCode.Tests.Y2030.D25;

public class Y2030D25Tests
{
    private readonly Y2030D25 _challenge = new Y2030D25();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D25\Y2030D25-input.txt", Encoding.UTF8);
