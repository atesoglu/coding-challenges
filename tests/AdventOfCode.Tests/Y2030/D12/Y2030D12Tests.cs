...
namespace AdventOfCode.Tests.Y2030.D12;

public class Y2030D12Tests
{
    private readonly Y2030D12 _challenge = new Y2030D12();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D12\Y2030D12-input.txt", Encoding.UTF8);
