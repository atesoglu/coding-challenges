...
namespace AdventOfCode.Tests.Y2030.D15;

public class Y2030D15Tests
{
    private readonly Y2030D15 _challenge = new Y2030D15();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D15\Y2030D15-input.txt", Encoding.UTF8);
