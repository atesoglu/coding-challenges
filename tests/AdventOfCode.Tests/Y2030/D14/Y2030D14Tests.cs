...
namespace AdventOfCode.Tests.Y2030.D14;

public class Y2030D14Tests
{
    private readonly Y2030D14 _challenge = new Y2030D14();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D14\Y2030D14-input.txt", Encoding.UTF8);
