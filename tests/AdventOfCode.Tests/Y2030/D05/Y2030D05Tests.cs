...
namespace AdventOfCode.Tests.Y2030.D05;

public class Y2030D05Tests
{
    private readonly Y2030D05 _challenge = new Y2030D05();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D05\Y2030D05-input.txt", Encoding.UTF8);
