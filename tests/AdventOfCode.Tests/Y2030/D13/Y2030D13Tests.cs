...
namespace AdventOfCode.Tests.Y2030.D13;

public class Y2030D13Tests
{
    private readonly Y2030D13 _challenge = new Y2030D13();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D13\Y2030D13-input.txt", Encoding.UTF8);
