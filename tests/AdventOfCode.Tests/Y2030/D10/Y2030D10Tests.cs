...
namespace AdventOfCode.Tests.Y2030.D10;

public class Y2030D10Tests
{
    private readonly Y2030D10 _challenge = new Y2030D10();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D10\Y2030D10-input.txt", Encoding.UTF8);
