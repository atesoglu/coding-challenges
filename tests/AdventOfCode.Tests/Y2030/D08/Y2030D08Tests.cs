...
namespace AdventOfCode.Tests.Y2030.D08;

public class Y2030D08Tests
{
    private readonly Y2030D08 _challenge = new Y2030D08();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D08\Y2030D08-input.txt", Encoding.UTF8);
