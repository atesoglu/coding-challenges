...
namespace AdventOfCode.Tests.Y2030.D21;

public class Y2030D21Tests
{
    private readonly Y2030D21 _challenge = new Y2030D21();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D21\Y2030D21-input.txt", Encoding.UTF8);
