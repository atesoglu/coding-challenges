...
namespace AdventOfCode.Tests.Y2030.D18;

public class Y2030D18Tests
{
    private readonly Y2030D18 _challenge = new Y2030D18();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D18\Y2030D18-input.txt", Encoding.UTF8);
