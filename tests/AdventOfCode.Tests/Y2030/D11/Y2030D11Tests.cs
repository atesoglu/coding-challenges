...
namespace AdventOfCode.Tests.Y2030.D11;

public class Y2030D11Tests
{
    private readonly Y2030D11 _challenge = new Y2030D11();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D11\Y2030D11-input.txt", Encoding.UTF8);
