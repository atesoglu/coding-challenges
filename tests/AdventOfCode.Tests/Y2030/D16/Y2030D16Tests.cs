...
namespace AdventOfCode.Tests.Y2030.D16;

public class Y2030D16Tests
{
    private readonly Y2030D16 _challenge = new Y2030D16();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D16\Y2030D16-input.txt", Encoding.UTF8);
