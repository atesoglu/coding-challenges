...
namespace AdventOfCode.Tests.Y2030.D24;

public class Y2030D24Tests
{
    private readonly Y2030D24 _challenge = new Y2030D24();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D24\Y2030D24-input.txt", Encoding.UTF8);
