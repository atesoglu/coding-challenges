...
namespace AdventOfCode.Tests.Y2030.D17;

public class Y2030D17Tests
{
    private readonly Y2030D17 _challenge = new Y2030D17();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D17\Y2030D17-input.txt", Encoding.UTF8);
