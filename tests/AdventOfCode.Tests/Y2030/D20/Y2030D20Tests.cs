...
public class Y2030D20Tests
{
    private readonly Y2030D20 _challenge = new Y2030D20();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D20\Y2030D20-input.txt", Encoding.UTF8);
