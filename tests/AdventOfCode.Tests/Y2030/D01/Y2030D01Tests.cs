...
public class Y2030D01Tests
{
    private readonly Y2030D01 _challenge = new Y2030D01();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D01\Y2030D01-input.txt", Encoding.UTF8);
