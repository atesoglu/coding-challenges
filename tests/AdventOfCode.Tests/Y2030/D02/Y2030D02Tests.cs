...
namespace AdventOfCode.Tests.Y2030.D02;

public class Y2030D02Tests
{
    private readonly Y2030D02 _challenge = new Y2030D02();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D02\Y2030D02-input.txt", Encoding.UTF8);
