...
namespace AdventOfCode.Tests.Y2030.D04;

public class Y2030D04Tests
{
    private readonly Y2030D04 _challenge = new Y2030D04();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D04\Y2030D04-input.txt", Encoding.UTF8);
