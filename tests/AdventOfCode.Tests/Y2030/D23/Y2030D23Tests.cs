...
namespace AdventOfCode.Tests.Y2030.D23;

public class Y2030D23Tests
{
    private readonly Y2030D23 _challenge = new Y2030D23();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2030\D23\Y2030D23-input.txt", Encoding.UTF8);
