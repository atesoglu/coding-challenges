...
namespace AdventOfCode.Tests.Y2035.D13;

public class Y2035D13Tests
{
    private readonly Y2035D13 _challenge = new Y2035D13();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D13\Y2035D13-input.txt", Encoding.UTF8);
