...
namespace AdventOfCode.Tests.Y2035.D18;

public class Y2035D18Tests
{
    private readonly Y2035D18 _challenge = new Y2035D18();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D18\Y2035D18-input.txt", Encoding.UTF8);
