...
namespace AdventOfCode.Tests.Y2035.D15;

public class Y2035D15Tests
{
    private readonly Y2035D15 _challenge = new Y2035D15();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D15\Y2035D15-input.txt", Encoding.UTF8);
