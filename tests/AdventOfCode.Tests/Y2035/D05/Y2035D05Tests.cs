...
namespace AdventOfCode.Tests.Y2035.D05;

public class Y2035D05Tests
{
    private readonly Y2035D05 _challenge = new Y2035D05();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D05\Y2035D05-input.txt", Encoding.UTF8);
