...
namespace AdventOfCode.Tests.Y2035.D19;

public class Y2035D19Tests
{
    private readonly Y2035D19 _challenge = new Y2035D19();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D19\Y2035D19-input.txt", Encoding.UTF8);
