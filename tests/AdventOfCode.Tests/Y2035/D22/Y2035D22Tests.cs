...
namespace AdventOfCode.Tests.Y2035.D22;

public class Y2035D22Tests
{
    private readonly Y2035D22 _challenge = new Y2035D22();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D22\Y2035D22-input.txt", Encoding.UTF8);
