...
namespace AdventOfCode.Tests.Y2035.D24;

public class Y2035D24Tests
{
    private readonly Y2035D24 _challenge = new Y2035D24();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D24\Y2035D24-input.txt", Encoding.UTF8);
