...
namespace AdventOfCode.Tests.Y2035.D09;

public class Y2035D09Tests
{
    private readonly Y2035D09 _challenge = new Y2035D09();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D09\Y2035D09-input.txt", Encoding.UTF8);
