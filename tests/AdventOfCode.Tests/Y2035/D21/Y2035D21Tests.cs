...
namespace AdventOfCode.Tests.Y2035.D21;

public class Y2035D21Tests
{
    private readonly Y2035D21 _challenge = new Y2035D21();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D21\Y2035D21-input.txt", Encoding.UTF8);
