...
public class Y2035D25Tests
{
    private readonly Y2035D25 _challenge = new Y2035D25();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D25\Y2035D25-input.txt", Encoding.UTF8);
