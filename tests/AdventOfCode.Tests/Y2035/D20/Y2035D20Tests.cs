...
public class Y2035D20Tests
{
    private readonly Y2035D20 _challenge = new Y2035D20();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D20\Y2035D20-input.txt", Encoding.UTF8);
