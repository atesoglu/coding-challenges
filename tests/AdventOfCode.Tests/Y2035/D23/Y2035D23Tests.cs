...
namespace AdventOfCode.Tests.Y2035.D23;

public class Y2035D23Tests
{
    private readonly Y2035D23 _challenge = new Y2035D23();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D23\Y2035D23-input.txt", Encoding.UTF8);
