...
namespace AdventOfCode.Tests.Y2035.D16;

public class Y2035D16Tests
{
    private readonly Y2035D16 _challenge = new Y2035D16();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D16\Y2035D16-input.txt", Encoding.UTF8);
