...
namespace AdventOfCode.Tests.Y2035.D04;

public class Y2035D04Tests
{
    private readonly Y2035D04 _challenge = new Y2035D04();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D04\Y2035D04-input.txt", Encoding.UTF8);
