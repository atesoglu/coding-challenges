...
namespace AdventOfCode.Tests.Y2035.D12;

public class Y2035D12Tests
{
    private readonly Y2035D12 _challenge = new Y2035D12();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D12\Y2035D12-input.txt", Encoding.UTF8);
