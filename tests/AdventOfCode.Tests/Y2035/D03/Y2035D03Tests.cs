...
namespace AdventOfCode.Tests.Y2035.D03;

public class Y2035D03Tests
{
    private readonly Y2035D03 _challenge = new Y2035D03();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D03\Y2035D03-input.txt", Encoding.UTF8);
