...
namespace AdventOfCode.Tests.Y2035.D06;

public class Y2035D06Tests
{
    private readonly Y2035D06 _challenge = new Y2035D06();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D06\Y2035D06-input.txt", Encoding.UTF8);
