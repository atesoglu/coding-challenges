...
namespace AdventOfCode.Tests.Y2035.D10;

public class Y2035D10Tests
{
    private readonly Y2035D10 _challenge = new Y2035D10();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D10\Y2035D10-input.txt", Encoding.UTF8);
