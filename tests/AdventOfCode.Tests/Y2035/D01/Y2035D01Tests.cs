...
namespace AdventOfCode.Tests.Y2035.D01;

public class Y2035D01Tests
{
    private readonly Y2035D01 _challenge = new Y2035D01();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D01\Y2035D01-input.txt", Encoding.UTF8);
