...
namespace AdventOfCode.Tests.Y2035.D14;

public class Y2035D14Tests
{
    private readonly Y2035D14 _challenge = new Y2035D14();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D14\Y2035D14-input.txt", Encoding.UTF8);
