...
namespace AdventOfCode.Tests.Y2035.D11;

public class Y2035D11Tests
{
    private readonly Y2035D11 _challenge = new Y2035D11();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D11\Y2035D11-input.txt", Encoding.UTF8);
