...
namespace AdventOfCode.Tests.Y2035.D08;

public class Y2035D08Tests
{
    private readonly Y2035D08 _challenge = new Y2035D08();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D08\Y2035D08-input.txt", Encoding.UTF8);
