...
namespace AdventOfCode.Tests.Y2035.D07;

public class Y2035D07Tests
{
    private readonly Y2035D07 _challenge = new Y2035D07();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D07\Y2035D07-input.txt", Encoding.UTF8);
