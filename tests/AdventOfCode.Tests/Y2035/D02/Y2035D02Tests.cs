...
namespace AdventOfCode.Tests.Y2035.D02;

public class Y2035D02Tests
{
    private readonly Y2035D02 _challenge = new Y2035D02();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D02\Y2035D02-input.txt", Encoding.UTF8);
