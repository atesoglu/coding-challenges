...
namespace AdventOfCode.Tests.Y2035.D17;

public class Y2035D17Tests
{
    private readonly Y2035D17 _challenge = new Y2035D17();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2035\D17\Y2035D17-input.txt", Encoding.UTF8);
