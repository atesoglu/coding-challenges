...
public class Y2032D25Tests
{
    private readonly Y2032D25 _challenge = new Y2032D25();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D25\Y2032D25-input.txt", Encoding.UTF8);
