...
namespace AdventOfCode.Tests.Y2032.D19;

public class Y2032D19Tests
{
    private readonly Y2032D19 _challenge = new Y2032D19();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D19\Y2032D19-input.txt", Encoding.UTF8);
