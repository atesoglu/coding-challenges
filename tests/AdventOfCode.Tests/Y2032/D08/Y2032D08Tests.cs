...
namespace AdventOfCode.Tests.Y2032.D08;

public class Y2032D08Tests
{
    private readonly Y2032D08 _challenge = new Y2032D08();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D08\Y2032D08-input.txt", Encoding.UTF8);
