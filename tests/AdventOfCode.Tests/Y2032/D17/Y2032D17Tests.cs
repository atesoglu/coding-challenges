...
namespace AdventOfCode.Tests.Y2032.D17;

public class Y2032D17Tests
{
    private readonly Y2032D17 _challenge = new Y2032D17();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D17\Y2032D17-input.txt", Encoding.UTF8);
