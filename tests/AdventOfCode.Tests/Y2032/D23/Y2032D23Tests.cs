...
public class Y2032D23Tests
{
    private readonly Y2032D23 _challenge = new Y2032D23();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D23\Y2032D23-input.txt", Encoding.UTF8);
