...
public class Y2032D12Tests
{
    private readonly Y2032D12 _challenge = new Y2032D12();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D12\Y2032D12-input.txt", Encoding.UTF8);
