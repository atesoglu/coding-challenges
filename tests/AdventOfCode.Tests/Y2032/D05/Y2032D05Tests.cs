...
public class Y2032D05Tests
{
    private readonly Y2032D05 _challenge = new Y2032D05();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D05\Y2032D05-input.txt", Encoding.UTF8);
