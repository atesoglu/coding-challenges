...
namespace AdventOfCode.Tests.Y2032.D04;

public class Y2032D04Tests
{
    private readonly Y2032D04 _challenge = new Y2032D04();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D04\Y2032D04-input.txt", Encoding.UTF8);
