...
namespace AdventOfCode.Tests.Y2032.D10;

public class Y2032D10Tests
{
    private readonly Y2032D10 _challenge = new Y2032D10();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D10\Y2032D10-input.txt", Encoding.UTF8);
