...
namespace AdventOfCode.Tests.Y2032.D01;

public class Y2032D01Tests
{
    private readonly Y2032D01 _challenge = new Y2032D01();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D01\Y2032D01-input.txt", Encoding.UTF8);
