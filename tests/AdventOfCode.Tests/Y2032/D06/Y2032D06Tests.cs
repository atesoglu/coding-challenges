...
namespace AdventOfCode.Tests.Y2032.D06;

public class Y2032D06Tests
{
    private readonly Y2032D06 _challenge = new Y2032D06();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D06\Y2032D06-input.txt", Encoding.UTF8);
