...
public class Y2032D11Tests
{
    private readonly Y2032D11 _challenge = new Y2032D11();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D11\Y2032D11-input.txt", Encoding.UTF8);
