...
namespace AdventOfCode.Tests.Y2032.D15;

public class Y2032D15Tests
{
    private readonly Y2032D15 _challenge = new Y2032D15();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D15\Y2032D15-input.txt", Encoding.UTF8);
