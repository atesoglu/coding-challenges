...
namespace AdventOfCode.Tests.Y2032.D16;

public class Y2032D16Tests
{
    private readonly Y2032D16 _challenge = new Y2032D16();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D16\Y2032D16-input.txt", Encoding.UTF8);
