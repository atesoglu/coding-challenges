...
public class Y2032D02Tests
{
    private readonly Y2032D02 _challenge = new Y2032D02();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D02\Y2032D02-input.txt", Encoding.UTF8);
