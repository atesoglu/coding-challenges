...
namespace AdventOfCode.Tests.Y2032.D03;

public class Y2032D03Tests
{
    private readonly Y2032D03 _challenge = new Y2032D03();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D03\Y2032D03-input.txt", Encoding.UTF8);
