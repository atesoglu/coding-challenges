...
namespace AdventOfCode.Tests.Y2032.D24;

public class Y2032D24Tests
{
    private readonly Y2032D24 _challenge = new Y2032D24();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D24\Y2032D24-input.txt", Encoding.UTF8);
