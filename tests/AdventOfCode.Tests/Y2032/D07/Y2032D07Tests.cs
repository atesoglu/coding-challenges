...
namespace AdventOfCode.Tests.Y2032.D07;

public class Y2032D07Tests
{
    private readonly Y2032D07 _challenge = new Y2032D07();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D07\Y2032D07-input.txt", Encoding.UTF8);
