...
public class Y2032D13Tests
{
    private readonly Y2032D13 _challenge = new Y2032D13();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D13\Y2032D13-input.txt", Encoding.UTF8);
