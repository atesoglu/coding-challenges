...
public class Y2032D09Tests
{
    private readonly Y2032D09 _challenge = new Y2032D09();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D09\Y2032D09-input.txt", Encoding.UTF8);
