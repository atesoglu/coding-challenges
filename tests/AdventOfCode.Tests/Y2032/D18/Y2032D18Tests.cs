...
namespace AdventOfCode.Tests.Y2032.D18;

public class Y2032D18Tests
{
    private readonly Y2032D18 _challenge = new Y2032D18();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D18\Y2032D18-input.txt", Encoding.UTF8);
