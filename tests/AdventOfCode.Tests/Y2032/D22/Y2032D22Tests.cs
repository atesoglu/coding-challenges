...
namespace AdventOfCode.Tests.Y2032.D22;

public class Y2032D22Tests
{
    private readonly Y2032D22 _challenge = new Y2032D22();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D22\Y2032D22-input.txt", Encoding.UTF8);
