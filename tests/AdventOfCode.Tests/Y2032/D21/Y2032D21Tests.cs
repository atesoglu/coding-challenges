...
public class Y2032D21Tests
{
    private readonly Y2032D21 _challenge = new Y2032D21();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D21\Y2032D21-input.txt", Encoding.UTF8);
