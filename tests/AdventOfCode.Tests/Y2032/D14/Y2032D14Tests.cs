...
namespace AdventOfCode.Tests.Y2032.D14;

public class Y2032D14Tests
{
    private readonly Y2032D14 _challenge = new Y2032D14();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2032\D14\Y2032D14-input.txt", Encoding.UTF8);
