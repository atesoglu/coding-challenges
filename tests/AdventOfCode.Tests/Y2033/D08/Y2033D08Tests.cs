...
namespace AdventOfCode.Tests.Y2033.D08;

public class Y2033D08Tests
{
    private readonly Y2033D08 _challenge = new Y2033D08();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D08\Y2033D08-input.txt", Encoding.UTF8);
