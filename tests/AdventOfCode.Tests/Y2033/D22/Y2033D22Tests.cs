...
namespace AdventOfCode.Tests.Y2033.D22;

public class Y2033D22Tests
{
    private readonly Y2033D22 _challenge = new Y2033D22();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D22\Y2033D22-input.txt", Encoding.UTF8);
