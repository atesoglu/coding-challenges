...
namespace AdventOfCode.Tests.Y2033.D02;

public class Y2033D02Tests
{
    private readonly Y2033D02 _challenge = new Y2033D02();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D02\Y2033D02-input.txt", Encoding.UTF8);
