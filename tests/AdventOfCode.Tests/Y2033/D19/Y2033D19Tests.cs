...
namespace AdventOfCode.Tests.Y2033.D19;

public class Y2033D19Tests
{
    private readonly Y2033D19 _challenge = new Y2033D19();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D19\Y2033D19-input.txt", Encoding.UTF8);
