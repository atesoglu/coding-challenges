...
namespace AdventOfCode.Tests.Y2033.D03;

public class Y2033D03Tests
{
    private readonly Y2033D03 _challenge = new Y2033D03();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D03\Y2033D03-input.txt", Encoding.UTF8);
