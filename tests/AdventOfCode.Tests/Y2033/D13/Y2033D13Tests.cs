...
namespace AdventOfCode.Tests.Y2033.D13;

public class Y2033D13Tests
{
    private readonly Y2033D13 _challenge = new Y2033D13();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D13\Y2033D13-input.txt", Encoding.UTF8);
