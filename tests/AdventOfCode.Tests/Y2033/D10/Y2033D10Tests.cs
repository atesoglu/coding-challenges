...
namespace AdventOfCode.Tests.Y2033.D10;

public class Y2033D10Tests
{
    private readonly Y2033D10 _challenge = new Y2033D10();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D10\Y2033D10-input.txt", Encoding.UTF8);
