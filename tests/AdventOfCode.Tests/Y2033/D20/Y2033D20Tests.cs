...
public class Y2033D20Tests
{
    private readonly Y2033D20 _challenge = new Y2033D20();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D20\Y2033D20-input.txt", Encoding.UTF8);
