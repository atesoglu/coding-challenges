...
namespace AdventOfCode.Tests.Y2033.D16;

public class Y2033D16Tests
{
    private readonly Y2033D16 _challenge = new Y2033D16();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D16\Y2033D16-input.txt", Encoding.UTF8);
