...
namespace AdventOfCode.Tests.Y2033.D12;

public class Y2033D12Tests
{
    private readonly Y2033D12 _challenge = new Y2033D12();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D12\Y2033D12-input.txt", Encoding.UTF8);
