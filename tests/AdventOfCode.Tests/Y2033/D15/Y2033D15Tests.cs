...
namespace AdventOfCode.Tests.Y2033.D15;

public class Y2033D15Tests
{
    private readonly Y2033D15 _challenge = new Y2033D15();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D15\Y2033D15-input.txt", Encoding.UTF8);
