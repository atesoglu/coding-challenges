...
namespace AdventOfCode.Tests.Y2033.D09;

public class Y2033D09Tests
{
    private readonly Y2033D09 _challenge = new Y2033D09();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D09\Y2033D09-input.txt", Encoding.UTF8);
