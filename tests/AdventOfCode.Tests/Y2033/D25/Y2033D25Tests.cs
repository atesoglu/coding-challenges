...
namespace AdventOfCode.Tests.Y2033.D25;

public class Y2033D25Tests
{
    private readonly Y2033D25 _challenge = new Y2033D25();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D25\Y2033D25-input.txt", Encoding.UTF8);
