...
namespace AdventOfCode.Tests.Y2033.D04;

public class Y2033D04Tests
{
    private readonly Y2033D04 _challenge = new Y2033D04();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D04\Y2033D04-input.txt", Encoding.UTF8);
