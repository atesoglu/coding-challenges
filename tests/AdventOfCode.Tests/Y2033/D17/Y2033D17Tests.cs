...
namespace AdventOfCode.Tests.Y2033.D17;

public class Y2033D17Tests
{
    private readonly Y2033D17 _challenge = new Y2033D17();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D17\Y2033D17-input.txt", Encoding.UTF8);
