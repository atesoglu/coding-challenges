...
namespace AdventOfCode.Tests.Y2033.D24;

public class Y2033D24Tests
{
    private readonly Y2033D24 _challenge = new Y2033D24();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D24\Y2033D24-input.txt", Encoding.UTF8);
