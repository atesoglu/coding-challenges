...
namespace AdventOfCode.Tests.Y2033.D23;

public class Y2033D23Tests
{
    private readonly Y2033D23 _challenge = new Y2033D23();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D23\Y2033D23-input.txt", Encoding.UTF8);
