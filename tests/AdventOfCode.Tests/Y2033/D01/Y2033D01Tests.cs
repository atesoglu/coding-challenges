...
namespace AdventOfCode.Tests.Y2033.D01;

public class Y2033D01Tests
{
    private readonly Y2033D01 _challenge = new Y2033D01();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D01\Y2033D01-input.txt", Encoding.UTF8);
