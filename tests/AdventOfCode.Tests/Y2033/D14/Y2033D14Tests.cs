...
namespace AdventOfCode.Tests.Y2033.D14;

public class Y2033D14Tests
{
    private readonly Y2033D14 _challenge = new Y2033D14();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D14\Y2033D14-input.txt", Encoding.UTF8);
