...
namespace AdventOfCode.Tests.Y2033.D06;

public class Y2033D06Tests
{
    private readonly Y2033D06 _challenge = new Y2033D06();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D06\Y2033D06-input.txt", Encoding.UTF8);
