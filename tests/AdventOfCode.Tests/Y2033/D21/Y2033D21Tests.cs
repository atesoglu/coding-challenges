...
namespace AdventOfCode.Tests.Y2033.D21;

public class Y2033D21Tests
{
    private readonly Y2033D21 _challenge = new Y2033D21();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D21\Y2033D21-input.txt", Encoding.UTF8);
