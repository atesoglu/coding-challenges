...
namespace AdventOfCode.Tests.Y2033.D11;

public class Y2033D11Tests
{
    private readonly Y2033D11 _challenge = new Y2033D11();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D11\Y2033D11-input.txt", Encoding.UTF8);
