...
namespace AdventOfCode.Tests.Y2033.D18;

public class Y2033D18Tests
{
    private readonly Y2033D18 _challenge = new Y2033D18();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D18\Y2033D18-input.txt", Encoding.UTF8);
