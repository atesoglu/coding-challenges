...
namespace AdventOfCode.Tests.Y2033.D05;

public class Y2033D05Tests
{
    private readonly Y2033D05 _challenge = new Y2033D05();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2033\D05\Y2033D05-input.txt", Encoding.UTF8);
