...
public class Y2017D15Tests
{
    private readonly Y2017D15 _challenge = new Y2017D15();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D15\Y2017D15-input.txt", Encoding.UTF8);
