...
public class Y2017D09Tests
{
    private readonly Y2017D09 _challenge = new Y2017D09();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D09\Y2017D09-input.txt", Encoding.UTF8);
