...
public class Y2017D08Tests
{
    private readonly Y2017D08 _challenge = new Y2017D08();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D08\Y2017D08-input.txt", Encoding.UTF8);
