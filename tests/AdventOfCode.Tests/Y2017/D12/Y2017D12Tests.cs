...
public class Y2017D12Tests
{
    private readonly Y2017D12 _challenge = new Y2017D12();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D12\Y2017D12-input.txt", Encoding.UTF8);
