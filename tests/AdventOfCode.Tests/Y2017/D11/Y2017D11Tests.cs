...
public class Y2017D11Tests
{
    private readonly Y2017D11 _challenge = new Y2017D11();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D11\Y2017D11-input.txt", Encoding.UTF8);
