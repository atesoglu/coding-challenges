...
public class Y2017D06Tests
{
    private readonly Y2017D06 _challenge = new Y2017D06();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D06\Y2017D06-input.txt", Encoding.UTF8);
