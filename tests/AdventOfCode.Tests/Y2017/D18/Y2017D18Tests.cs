...
public class Y2017D18Tests
{
    private readonly Y2017D18 _challenge = new Y2017D18();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D18\Y2017D18-input.txt", Encoding.UTF8);
