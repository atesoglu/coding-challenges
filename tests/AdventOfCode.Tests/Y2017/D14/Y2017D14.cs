...
[ChallengeName("Disk Defragmentation")]
public class Y2017D14
{
    private readonly string _input = File.ReadAllText(@"Y2017\D14\Y2017D14-input.txt", Encoding.UTF8);
    ...
    private IEnumerable<string> Extract(string input)
    {
