...
namespace AdventOfCode.Tests.Y2017.D14;

public class Y2017D14Tests
{
    private readonly Y2017D14 _challenge = new Y2017D14();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D14\Y2017D14-input.txt", Encoding.UTF8);
