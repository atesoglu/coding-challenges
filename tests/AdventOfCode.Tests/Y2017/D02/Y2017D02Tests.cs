...
public class Y2017D02Tests
{
    private readonly Y2017D02 _challenge = new Y2017D02();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D02\Y2017D02-input.txt", Encoding.UTF8);
