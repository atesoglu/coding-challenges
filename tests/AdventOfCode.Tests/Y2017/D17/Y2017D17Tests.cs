...
public class Y2017D17Tests
{
    private readonly Y2017D17 _challenge = new Y2017D17();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D17\Y2017D17-input.txt", Encoding.UTF8);
