...
public class Y2017D07Tests
{
    private readonly Y2017D07 _challenge = new Y2017D07();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D07\Y2017D07-input.txt", Encoding.UTF8);
