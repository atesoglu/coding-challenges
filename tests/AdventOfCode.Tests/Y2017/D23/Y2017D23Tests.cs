...
public class Y2017D23Tests
{
    private readonly Y2017D23 _challenge = new Y2017D23();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D23\Y2017D23-input.txt", Encoding.UTF8);
