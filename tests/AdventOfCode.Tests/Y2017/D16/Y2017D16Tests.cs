...
public class Y2017D16Tests
{
    private readonly Y2017D16 _challenge = new Y2017D16();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D16\Y2017D16-input.txt", Encoding.UTF8);
