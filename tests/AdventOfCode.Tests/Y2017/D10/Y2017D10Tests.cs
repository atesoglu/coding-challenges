...
public class Y2017D10Tests
{
    private readonly Y2017D10 _challenge = new Y2017D10();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D10\Y2017D10-input.txt", Encoding.UTF8);
