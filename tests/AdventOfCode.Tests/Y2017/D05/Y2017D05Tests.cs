...
public class Y2017D05Tests
{
    private readonly Y2017D05 _challenge = new Y2017D05();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D05\Y2017D05-input.txt", Encoding.UTF8);
