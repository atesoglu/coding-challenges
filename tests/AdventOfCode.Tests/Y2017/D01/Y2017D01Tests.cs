...
public class Y2017D01Tests
{
    private readonly Y2017D01 _challenge = new Y2017D01();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D01\Y2017D01-input.txt", Encoding.UTF8);
