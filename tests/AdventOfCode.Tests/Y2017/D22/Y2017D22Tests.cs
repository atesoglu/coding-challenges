...
public class Y2017D22Tests
{
    private readonly Y2017D22 _challenge = new Y2017D22();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D22\Y2017D22-input.txt", Encoding.UTF8);
