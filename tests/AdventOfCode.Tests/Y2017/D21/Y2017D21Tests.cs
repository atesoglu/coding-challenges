...
public class Y2017D21Tests
{
    private readonly Y2017D21 _challenge = new Y2017D21();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D21\Y2017D21-input.txt", Encoding.UTF8);
