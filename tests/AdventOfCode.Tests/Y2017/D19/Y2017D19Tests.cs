...
public class Y2017D19Tests
{
    private readonly Y2017D19 _challenge = new Y2017D19();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D19\Y2017D19-input.txt", Encoding.UTF8);
