...
public class Y2017D24Tests
{
    private readonly Y2017D24 _challenge = new Y2017D24();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D24\Y2017D24-input.txt", Encoding.UTF8);
