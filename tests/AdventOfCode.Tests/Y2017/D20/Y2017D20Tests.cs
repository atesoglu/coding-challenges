...
namespace AdventOfCode.Tests.Y2017.D20;

public class Y2017D20Tests
{
    private readonly Y2017D20 _challenge = new Y2017D20();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D20\Y2017D20-input.txt", Encoding.UTF8);
