...
public class Y2017D25Tests
{
    private readonly Y2017D25 _challenge = new Y2017D25();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D25\Y2017D25-input.txt", Encoding.UTF8);
