...
public class Y2017D03Tests
{
    private readonly Y2017D03 _challenge = new Y2017D03();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D03\Y2017D03-input.txt", Encoding.UTF8);
