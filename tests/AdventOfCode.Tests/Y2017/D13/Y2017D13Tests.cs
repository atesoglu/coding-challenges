...
public class Y2017D13Tests
{
    private readonly Y2017D13 _challenge = new Y2017D13();
    private readonly IEnumerable<string> _lines = File.ReadAllLines(@"Y2017\D13\Y2017D13-input.txt", Encoding.UTF8);
