...
public class Y2015D09Tests
{
    private readonly Y2015D09 _challenge = new Y2015D09();
    private readonly string _input = File.ReadAllText(@"Y2015\D09\Y2015D09-input.txt", Encoding.UTF8);
