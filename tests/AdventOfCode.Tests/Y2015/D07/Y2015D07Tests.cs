...
public class Y2015D07Tests
{
    private readonly Y2015D07 _challenge = new Y2015D07();
    private readonly string _input = File.ReadAllText(@"Y2015\D07\Y2015D07-input.txt", Encoding.UTF8);
