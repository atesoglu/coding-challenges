...
public class Y2015D16Tests
{
    private readonly Y2015D16 _challenge = new Y2015D16();
    private readonly string _input = File.ReadAllText(@"Y2015\D16\Y2015D16-input.txt", Encoding.UTF8);
