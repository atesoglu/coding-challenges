...
public class Y2015D22Tests
{
    private readonly Y2015D22 _challenge = new Y2015D22();
    private readonly string _input = File.ReadAllText(@"Y2015\D22\Y2015D22-input.txt", Encoding.UTF8);
