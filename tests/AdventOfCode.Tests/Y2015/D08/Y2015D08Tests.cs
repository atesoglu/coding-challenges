...
public class Y2015D08Tests
{
    private readonly Y2015D08 _challenge = new Y2015D08();
    private readonly string _input = File.ReadAllText(@"Y2015\D08\Y2015D08-input.txt", Encoding.UTF8);
