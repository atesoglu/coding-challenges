...
public class Y2015D14Tests
{
    private readonly Y2015D14 _challenge = new Y2015D14();
    private readonly string _input = File.ReadAllText(@"Y2015\D14\Y2015D14-input.txt", Encoding.UTF8);
