...
public class Y2015D17Tests
{
    private readonly Y2015D17 _challenge = new Y2015D17();
    private readonly string _input = File.ReadAllText(@"Y2015\D17\Y2015D17-input.txt", Encoding.UTF8);
