...
public class Y2015D24Tests
{
    private readonly Y2015D24 _challenge = new Y2015D24();
    private readonly string _input = File.ReadAllText(@"Y2015\D24\Y2015D24-input.txt", Encoding.UTF8);
