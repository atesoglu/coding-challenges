...
public class Y2015D18Tests
{
    private readonly Y2015D18 _challenge = new Y2015D18();
    private readonly string _input = File.ReadAllText(@"Y2015\D18\Y2015D18-input.txt", Encoding.UTF8);
