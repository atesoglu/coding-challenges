...
public class Y2015D15Tests
{
    private readonly Y2015D15 _challenge = new Y2015D15();
    private readonly string _input = File.ReadAllText(@"Y2015\D15\Y2015D15-input.txt", Encoding.UTF8);
