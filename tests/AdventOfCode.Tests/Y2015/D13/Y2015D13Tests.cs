...
public class Y2015D13Tests
{
    private readonly Y2015D13 _challenge = new Y2015D13();
    private readonly string _input = File.ReadAllText(@"Y2015\D13\Y2015D13-input.txt", Encoding.UTF8);
