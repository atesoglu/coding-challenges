...
public class Y2015D19Tests
{
    private readonly Y2015D19 _challenge = new Y2015D19();
    private readonly string _input = File.ReadAllText(@"Y2015\D19\Y2015D19-input.txt", Encoding.UTF8);
