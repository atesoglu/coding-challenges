...
namespace AdventOfCode.Y2021.D14;

[ChallengeName("Extended Polymerization")]
public class Y2021D14
{
    private readonly string _input = File.ReadAllText(@"Y2021\D14\Y2021D14-input.txt", Encoding.UTF8);
