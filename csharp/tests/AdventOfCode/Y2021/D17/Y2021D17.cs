...
namespace AdventOfCode.Y2021.D17;

[ChallengeName("Trick Shot")]
public class Y2021D17
{
    private readonly string _input = File.ReadAllText(@"Y2021\D17\Y2021D17-input.txt", Encoding.UTF8);
    ...
    private static IEnumerable<int> Solve(string input)
    {
        ...
        var vy0Max = -yMin; // ðŸŽ Newton says that when the falling probe reaches y = 0, it's speed is -vy0.
