...
namespace AdventOfCode.Y2018.D16;

[ChallengeName("Chronal Classification")]
public class Y2018D16
{
    private readonly string _input = File.ReadAllText(@"Y2018\D16\Y2018D16-input.txt", Encoding.UTF8);
