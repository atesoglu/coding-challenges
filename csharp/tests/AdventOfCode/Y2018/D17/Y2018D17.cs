...
namespace AdventOfCode.Y2018.D17;

[ChallengeName("Reservoir Research")]
public class Y2018D17
{
    private readonly string _input = File.ReadAllText(@"Y2018\D17\Y2018D17-input.txt", Encoding.UTF8);
