...
namespace AdventOfCode.Y2016.D15;
...
public class Y2016D15
{
    ...
    private static (int pos, int mod)[] Parse(string input) => (
    ...
    private static IEnumerable<(int t, bool ok)> Iterate((int pos, int mod)[] discs)
    {
        for (var t = 0;; t++)
        {
